...
import { cilPlus, cilDelete, cilPencil, cilSearch, cilActionUndo, cilHistory, cilBan, cilOptions, cilBuilding, cilPrint, cilAvTimer, cilNoteAdd } from '@coreui/icons';
...
export class ListaTessereComponent implements OnInit, AfterViewInit {
  ...
  icons = { cilPrint, cilBan, cilPlus, cilDelete, cilPencil, cilActionUndo, cilSearch, cilHistory, cilOptions, cilBuilding, cilAvTimer, cilNoteAdd };
