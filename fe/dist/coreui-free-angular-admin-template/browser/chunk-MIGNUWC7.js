...
var DefaultFooterComponent = class _DefaultFooterComponent extends FooterComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DefaultFooterComponent, selectors: [["app-default-footer"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 27, vars: 7, consts: [[1, "footer-container"], [1, "footer-version-section"], [1, "version-card"], [1, "version-title"], [1, "version-date"], [1, "version-number"], ["href", "https://bloob.io/yatch", "target", "_blank"]], template: function DefaultFooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(14);
        \u0275\u0275domElementEnd();
        \u0275\u0275domElementStart(15, "div", 5);
        \u0275\u0275text(16);
        \u0275\u0275domElementEnd();
        \u0275\u0275domElementStart(17, "div", 4);
        \u0275\u0275text(18);
        \u0275\u0275domElementEnd()()();
        \u0275\u0275domElementStart(19, "div", 2)(20, "div", 3);
        \u0275\u0275text(21, "Autori");
        \u0275\u0275domElementEnd();
        \u0275\u0275domElementStart(22, "div", 5);
        \u0275\u0275text(23, " Powered by ");
        \u0275\u0275domElementStart(24, "a", 6)(25, "span");
        \u0275\u0275text(26, " SN, LG, MT");
        \u0275\u0275domElementEnd()()()()();
      }
      if (rf & 2) {
        ...
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1("\u{1F4CD} ", ctx.weatherInfo().city);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate2(" Today ", ctx.weatherIcon(ctx.weatherInfo().todayCode), " ", ctx.weatherInfo().todayTemp, "\xB0C ");
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate2(" Tomorrow ", ctx.weatherIcon(ctx.weatherInfo().tomorrowCode), " ", ctx.weatherInfo().tomorrowTemp, "\xB0C ");
      }
