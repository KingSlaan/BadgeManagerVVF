...
var VersionService = class _VersionService {
  ...
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _VersionService, factory: _VersionService.\u0275fac, providedIn: "root" });
  }
};
(() => {
...
var WeatherService = class _WeatherService {
  ...
  getRomeWeather() {
    return this.http.get("https://api.open-meteo.com/v1/forecast?latitude=41.9028&longitude=12.4964&current=temperature_2m,weather_code&daily=weather_code,temperature_2m_max&forecast_days=2");
  }
  static {
    this.\u0275fac = function WeatherService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _WeatherService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _WeatherService, factory: _WeatherService.\u0275fac, providedIn: "root" });
  }
};
(() => {
...
function DefaultFooterComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 4);
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(2, "div", 6);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "date");
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.versionInfo().version, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 2, ctx_r0.versionInfo().buildDate, "d/MM/y HH:mm:ss"), " ");
  }
}
function DefaultFooterComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 4);
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", ctx_r0.versionInfoBE().version, "-", ctx_r0.versionInfoBE().codeName, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r0.versionInfoBE().buildDate, " ");
  }
}
function DefaultFooterComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const weather_r2 = ctx;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("\u{1F4CD} ", weather_r2.city);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" Today ", ctx_r0.weatherIcon(weather_r2.todayCode), " ", weather_r2.todayTemp, "\xB0C ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" Tomorrow ", ctx_r0.weatherIcon(weather_r2.tomorrowCode), " ", weather_r2.tomorrowTemp, "\xB0C ");
  }
}
function DefaultFooterComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 4);
    \u0275\u0275text(1, "--");
    \u0275\u0275domElementEnd();
...
var DefaultFooterComponent = class _DefaultFooterComponent extends FooterComponent {
  constructor() {
    ...
    this.versionInfoBE = signal({
      "appName": "Applicativo Badge VVF",
      "version": "0.0.0",
      "codeName": "",
      "buildDate": ""
    }, ...ngDevMode ? [{ debugName: "versionInfoBE" }] : (
      /* istanbul ignore next */
      []
    ));
    this.weatherInfo = signal(null, ...ngDevMode ? [{ debugName: "weatherInfo" }] : (
      /* istanbul ignore next */
      []
    ));
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DefaultFooterComponent, selectors: [["app-default-footer"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 23, vars: 3, consts: [[1, "footer-container"], [1, "footer-version-section"], [1, "version-card"], [1, "version-title"], [1, "version-number"], ["href", "https://frontwars.io", "target", "_blank"], [1, "version-date"]], template: function DefaultFooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275domElementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "div", 3);
        \u0275\u0275text(4, "Frontend");
        \u0275\u0275domElementEnd();
        \u0275\u0275conditionalCreate(5, DefaultFooterComponent_Conditional_5_Template, 5, 5);
        \u0275\u0275domElementEnd();
        \u0275\u0275domElementStart(6, "div", 2)(7, "div", 3);
        \u0275\u0275text(8, "Backend");
        \u0275\u0275domElementEnd();
        \u0275\u0275conditionalCreate(9, DefaultFooterComponent_Conditional_9_Template, 4, 3);
        \u0275\u0275domElementEnd();
        \u0275\u0275domElementStart(10, "div", 2)(11, "div", 3);
        \u0275\u0275text(12, "Weather");
        \u0275\u0275domElementEnd();
        \u0275\u0275conditionalCreate(13, DefaultFooterComponent_Conditional_13_Template, 6, 5)(14, DefaultFooterComponent_Conditional_14_Template, 4, 0);
        \u0275\u0275domElementEnd()();
        \u0275\u0275domElementStart(15, "div", 2)(16, "div", 3);
        \u0275\u0275text(17, "Autori");
        \u0275\u0275domElementEnd();
        \u0275\u0275domElementStart(18, "div", 4);
        \u0275\u0275text(19, " Powered by ");
        \u0275\u0275domElementStart(20, "a", 5)(21, "span");
        \u0275\u0275text(22, " SN, LG, MT, FSC");
        \u0275\u0275domElementEnd()()()()();
      }
      if (rf & 2) {
        let tmp_2_0;
        \u0275\u0275advance(5);
        \u0275\u0275conditional(ctx.versionInfo() ? 5 : -1);
        \u0275\u0275advance(4);
        \u0275\u0275conditional(ctx.versionInfoBE() ? 9 : -1);
        \u0275\u0275advance(4);
        \u0275\u0275conditional((tmp_2_0 = ctx.weatherInfo()) ? 13 : 14, tmp_2_0);
      }
    }, dependencies: [DatePipe], styles: ["\n.version-card[_ngcontent-%COMP%] {\n  min-width: 180px;\n  padding: 0.5rem 1rem;\n  border: 1px solid var(--app-border);\n  border-radius: 8px;\n  background-color: var(--app-surface);\n  text-align: center;\n}\n.version-title[_ngcontent-%COMP%] {\n  font-size: 0.55rem;\n  font-weight: 600;\n  text-transform: uppercase;\n  color: var(--app-text-muted);\n}\n.version-number[_ngcontent-%COMP%] {\n  font-size: 0.65rem;\n  font-weight: 700;\n  color: var(--app-text);\n}\n.version-date[_ngcontent-%COMP%] {\n  font-size: 0.65rem;\n  color: var(--app-text-muted);\n}\n.footer-container[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  width: 100%;\n}\n.footer-version-section[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 1rem;\n}\n.footer-container[_ngcontent-%COMP%]    > .version-card[_ngcontent-%COMP%]:last-child {\n  margin-left: auto;\n}\n/*# sourceMappingURL=default-footer.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DefaultFooterComponent, [{
    type: Component,
    args: [{ selector: "app-default-footer", imports: [DatePipe], template: '<div class="footer-container">\r\n  <div class="footer-version-section">\r\n    <div class="version-card">\r\n      <div class="version-title">Frontend</div>\r\n\r\n      @if (versionInfo()) {\r\n        <div class="version-number">\r\n          {{ versionInfo().version }}\r\n        </div>\r\n\r\n        <div class="version-date">\r\n          {{ versionInfo().buildDate | date: "d/MM/y HH:mm:ss" }}\r\n        </div>\r\n      }\r\n    </div>\r\n\r\n    <div class="version-card">\r\n      <div class="version-title">Backend</div>\r\n\r\n      @if (versionInfoBE()) {\r\n        <div class="version-number">\r\n          {{ versionInfoBE().version }}-{{versionInfoBE().codeName}}\r\n        </div>\r\n\r\n        <div class="version-date">\r\n          {{ versionInfoBE().buildDate }}\r\n        </div>\r\n      }\r\n    </div>\r\n\r\n    <div class="version-card">\r\n      <div class="version-title">Weather</div>\r\n\r\n      @if (weatherInfo(); as weather) {\r\n        <div class="version-date">\u{1F4CD} {{ weather.city }}</div>\r\n\r\n        <div class="version-number">\r\n          Today\r\n          {{ weatherIcon(weather.todayCode) }}\r\n          {{ weather.todayTemp }}\xB0C\r\n        </div>\r\n\r\n        <div class="version-date">\r\n          Tomorrow\r\n          {{ weatherIcon(weather.tomorrowCode) }}\r\n          {{ weather.tomorrowTemp }}\xB0C\r\n        </div>\r\n      } @else {\r\n        <div class="version-number">--</div>\r\n        <div class="version-date">Loading...</div>\r\n      }\r\n    </div>\r\n  </div>\r\n\r\n  <div class="version-card">\r\n    <div class="version-title">Autori</div>\r\n\r\n    <div class="version-number">\r\n      Powered by\r\n      <a href="https://frontwars.io" target="_blank">\r\n        <span> SN, LG, MT, FSC</span>\r\n      </a>\r\n    </div>\r\n  </div>\r\n</div>\r\n', styles: ["/* src/app/layout/default-layout/default-footer/default-footer.component.scss */\n.version-card {\n  min-width: 180px;\n  padding: 0.5rem 1rem;\n  border: 1px solid var(--app-border);\n  border-radius: 8px;\n  background-color: var(--app-surface);\n  text-align: center;\n}\n.version-title {\n  font-size: 0.55rem;\n  font-weight: 600;\n  text-transform: uppercase;\n  color: var(--app-text-muted);\n}\n.version-number {\n  font-size: 0.65rem;\n  font-weight: 700;\n  color: var(--app-text);\n}\n.version-date {\n  font-size: 0.65rem;\n  color: var(--app-text-muted);\n}\n.footer-container {\n  display: flex;\n  align-items: center;\n  width: 100%;\n}\n.footer-version-section {\n  display: flex;\n  gap: 1rem;\n}\n.footer-container > .version-card:last-child {\n  margin-left: auto;\n}\n/*# sourceMappingURL=default-footer.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DefaultFooterComponent, { className: "DefaultFooterComponent", filePath: "src/app/layout/default-layout/default-footer/default-footer.component.ts", lineNumber: 14 });
})();

// src/assets/version.json
var version_default = {
  version: "3.3.2-ArkNova",
  environment: "dev",
  buildDate: "2026-06-22T14:43:17.999Z"
};
...
function DefaultHeaderComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6, " Impostazioni ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "li", 16)(8, "a", 17);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(9, "svg", 18);
    \u0275\u0275text(10, " Utente ");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", function DefaultHeaderComponent_ng_template_14_Template_a_click_12_listener() {
      \u0275\u0275restoreView(_r1);
  ...
  if (rf & 2) {
    \u0275\u0275property("popperOptions", \u0275\u0275pureFunction0(2, _c0));
    \u0275\u0275advance();
    \u0275\u0275property("caret", false);
  }
}
function DefaultHeaderComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 21);
    \u0275\u0275listener("click", function DefaultHeaderComponent_ng_template_16_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setSimpleColorMode(ctx_r1.colorMode()));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(1, "svg", 22);
    \u0275\u0275elementEnd();
...
var DefaultHeaderComponent = class _DefaultHeaderComponent extends HeaderComponent {
  ...
  constructor() {
    ...
    this.currentTime = signal(/* @__PURE__ */ new Date(), ...ngDevMode ? [{ debugName: "currentTime" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DefaultHeaderComponent, selectors: [["app-default-header"]], inputs: { sidebarId: [1, "sidebarId"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 18, vars: 9, consts: [["userDropdown", ""], ["themeDropdown", ""], [1, "border-bottom", "px-4", 3, "fluid"], ["cHeaderToggler", "", "toggle", "visible", "aria-label", "Toggle sidebar navigation", 1, "btn", 2, "margin-inline-start", "-14px", 3, "cSidebarToggle"], ["cIcon", "", "name", "cilMenu", "size", "lg"], [1, "mx-0", "d-flex", "align-items-center", "gap-2"], [3, "ngClass"], [1, "header-clock"], ["size", "sm", "title", "Time", 1, "me-1", 3, "cIcon"], [4, "ngTemplateOutlet"], [1, "px-4", 3, "fluid"], ["variant", "nav-item", 3, "popperOptions"], ["cDropdownToggle", "", "aria-label", "Open user menu", 1, "py-0", "pe-0", 3, "caret"], ["shape", "rounded-1", "size", "md", "src", "./assets/images/placeholder_icon_user.svg", "status", "success", "textColor", "primary", "alt", "User avatar"], ["cDropdownMenu", "", 1, "pt-0", "w-auto"], ["cDropdownHeader", "", 1, "bg-body-secondary", "text-body-secondary", "fw-semibold", "p-2"], [1, "pX-0"], ["cDropdownItem", "", "routerLink", "user-settings"], ["cIcon", "", "name", "cilSettings", 1, "me-2"], ["cDropdownItem", "", 3, "click"], ["cIcon", "", "name", "cilAccountLogout", 1, "me-2"], ["cButton", "", "variant", "ghost", "shape", "rounded-pill", "direction", "dropend", 3, "click"], ["cIcon", "", "size", "lg", 3, "name"]], template: function DefaultHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(4, "c-header-nav", 5)(5, "span", 6);
        \u0275\u0275text(6);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(9);
        \u0275\u0275elementEnd();
        \u0275\u0275template(10, DefaultHeaderComponent_ng_container_10_Template, 1, 0, "ng-container", 9)(11, DefaultHeaderComponent_ng_container_11_Template, 1, 0, "ng-container", 9);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(12, "c-container", 10);
        \u0275\u0275element(13, "c-breadcrumb-router");
        \u0275\u0275elementEnd();
        \u0275\u0275elementContainerEnd();
        \u0275\u0275template(14, DefaultHeaderComponent_ng_template_14_Template, 15, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(16, DefaultHeaderComponent_ng_template_16_Template, 2, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        const userDropdown_r4 = \u0275\u0275reference(15);
        const themeDropdown_r5 = \u0275\u0275reference(17);
        \u0275\u0275advance();
        \u0275\u0275property("fluid", true);
        \u0275\u0275advance();
        \u0275\u0275property("cSidebarToggle", ctx.sidebarId());
        \u0275\u0275advance(3);
        \u0275\u0275property("ngClass", ctx.envClass);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", ctx.envLabel, " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("cIcon", ctx.iconsStatic.cilClock);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", ctx.formattedDateTime, " ");
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DefaultHeaderComponent, [{
    ...
    args: [{ selector: "app-default-header", imports: [
      ...
      NgClass,
      ButtonDirective
    ], template: `<!--<c-header class="mb-4 d-print-none" position="sticky">-->\r
<ng-container>\r
  <c-container [fluid]="true" class="border-bottom px-4">\r
    <button\r
      [cSidebarToggle]="sidebarId()"\r
      cHeaderToggler\r
      class="btn"\r
      toggle="visible"\r
      style="margin-inline-start: -14px"\r
      aria-label="Toggle sidebar navigation"\r
    >\r
      <svg cIcon name="cilMenu" size="lg"></svg>\r
    </button>\r
\r
    <c-header-nav class="mx-0 d-flex align-items-center gap-2">\r
      <span [ngClass]="envClass">\r
        {{ envLabel }}\r
      </span>\r
      <span class="header-clock">\r
        <svg\r
          [cIcon]="iconsStatic.cilClock"\r
          class="me-1"\r
          size="sm"\r
          title="Time"\r
        ></svg>\r
...
\r
      <ng-container *ngTemplateOutlet="themeDropdown" />\r
      <ng-container *ngTemplateOutlet="userDropdown" />\r
    </c-header-nav>\r
  </c-container>\r
  <c-container [fluid]="true" class="px-4">\r
    <c-breadcrumb-router />\r
  </c-container>\r
</ng-container>\r
<!--</c-header>-->\r
\r
<ng-template #userDropdown>\r
  <c-dropdown\r
    [popperOptions]="{ placement: 'bottom-start' }"\r
    variant="nav-item"\r
  >\r
    <button\r
      [caret]="false"\r
      cDropdownToggle\r
      class="py-0 pe-0"\r
      aria-label="Open user menu"\r
    >\r
      <c-avatar\r
        shape="rounded-1"\r
        size="md"\r
        src="./assets/images/placeholder_icon_user.svg"\r
        status="success"\r
        textColor="primary"\r
        alt="User avatar"\r
      />\r
    </button>\r
    <ul cDropdownMenu class="pt-0 w-auto">\r
      <li>\r
        <h6\r
          cDropdownHeader\r
          class="bg-body-secondary text-body-secondary fw-semibold p-2"\r
        >\r
          Impostazioni\r
        </h6>\r
      </li>\r
      <li class="pX-0">\r
        <a cDropdownItem routerLink="user-settings">\r
          <svg cIcon class="me-2" name="cilSettings"></svg>\r
          Utente\r
        </a>\r
      </li>\r
      <li>\r
        <a cDropdownItem (click)="logout()">\r
...
\r
<ng-template #themeDropdown>\r
  <button\r
    cButton\r
    variant="ghost"\r
    shape="rounded-pill"\r
    direction="dropend"\r
    (click)="setSimpleColorMode(colorMode())"\r
  >\r
    <svg cIcon [name]="icons()" size="lg"></svg>\r
  </button>\r
</ng-template>\r
\r
<!-- <ng-template #themeDropdownOld>\r
  <c-dropdown alignment="end" variant="nav-item">\r
    <button [caret]="false" cDropdownToggle aria-label="Open theme picker">\r
      <svg cIcon [name]="icons()" size="lg"></svg>\r
    </button>\r
    <div cDropdownMenu>\r
      @for (mode of colorModes; track mode.name) {\r
        <button\r
          (click)="colorMode.set(mode.name)"\r
          [active]="colorMode() === mode.name"\r
          cDropdownItem\r
          class="d-flex align-items-center"\r
        >\r
          <svg cIcon class="me-2" [name]="mode.icon" size="lg"></svg>\r
          {{ mode.text }}\r
        </button>\r
      }\r
    </div>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DefaultHeaderComponent, { className: "DefaultHeaderComponent", filePath: "src/app/layout/default-layout/default-header/default-header.component.ts", lineNumber: 53 });
})();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
      ...
      viewQuery: function NgScrollbar_Query(rf, ctx) {
        if (rf & 1) {
          \u0275\u0275viewQuery(_c02, 5, ElementRef)(_c1, 5, ElementRef)(ScrollViewport, 7);
        }
        if (rf & 2) {
          let _t;
...
var DefaultLayoutComponent = class _DefaultLayoutComponent {
  constructor() {
    ...
    this.#colorModeService = inject(ColorModeService);
    this.colorMode = this.#colorModeService.colorMode;
    this.sidebarNarrow = signal(false, ...ngDevMode ? [{ debugName: "sidebarNarrow" }] : (
      /* istanbul ignore next */
      []
    ));
    this.logoWidth = computed(() => {
      return this.sidebarNarrow() ? 40 : 220;
    }, ...ngDevMode ? [{ debugName: "logoWidth" }] : (
      /* istanbul ignore next */
      []
    ));
    this.logoSrc = computed(() => {
      ...
      if (theme === "dark") {
        return narrow ? "../../../assets/images/IconDEFINITIVO_NewVersion_White.svg" : "../../../assets/images/BannerDEFINITIVO_NewVersion_White.svg";
      }
      return narrow ? "../../../assets/images/IconDEFINITIVO_NewVersion.svg" : "../../../assets/images/BannerDEFINITIVO_NewVersion.svg";
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DefaultLayoutComponent, selectors: [["app-dashboard"]], decls: 15, vars: 8, consts: [["sidebar1", "cSidebar"], ["colorScheme", "light", "id", "sidebar1", "visible", "", 1, "d-print-none", "sidebar", "sidebar-fixed", "border-end", 3, "narrow"], [1, "border-bottom"], [3, "routerLink"], ["alt", "Logo", 1, "sidebar-logo", 3, "src", "width"], ["pointerEventsMethod", "scrollbar", "visibility", "hover"], ["dropdownMode", "path", "compact", "", 3, "navItems"], [1, "border-top", "d-none", "d-lg-flex", "justify-content-center", 2, "cursor", "pointer", 3, "click"], ["cSidebarToggler", "", "aria-label", "Toggle sidebar fold"], [1, "wrapper", "d-flex", "flex-column", "min-vh-100"], ["position", "sticky", 1, "mb-4", "d-print-none", "header", "header-sticky", "p-0", "shadow-sm", 3, "cShadowOnScroll", "sidebarId"], [1, "body", "flex-grow-1"], ["breakpoint", "lg", 1, "h-auto", "px-4"]], template: function DefaultLayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(7, "c-sidebar-footer", 7);
        \u0275\u0275listener("click", function DefaultLayoutComponent_Template_c_sidebar_footer_click_7_listener() {
          return ctx.toggleSidebarNarrow();
        });
        \u0275\u0275element(8, "button", 8);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(9, "div", 9);
        \u0275\u0275element(10, "app-default-header", 10);
        \u0275\u0275elementStart(11, "div", 11)(12, "c-container", 12);
        \u0275\u0275element(13, "router-outlet");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(14, "app-default-footer");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275property("narrow", ctx.sidebarNarrow());
        \u0275\u0275advance(3);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(7, _c03));
        \u0275\u0275advance();
        \u0275\u0275property("src", ctx.logoSrc(), \u0275\u0275sanitizeUrl)("width", ctx.logoWidth());
        \u0275\u0275advance(2);
        \u0275\u0275property("navItems", ctx.navItems);
        \u0275\u0275advance(4);
        \u0275\u0275property("cShadowOnScroll", "sm")("sidebarId", "sidebar1");
      }
    }, dependencies: [
      SidebarComponent,
      SidebarHeaderComponent,
...
<c-sidebar\r
  ...
  colorScheme="light"\r
  id="sidebar1"\r
  [narrow]="sidebarNarrow()"\r
  visible\r
>\r
  <c-sidebar-header class="border-bottom">\r
    <c-sidebar-brand [routerLink]="['/']">\r
      <img\r
        [src]="logoSrc()"\r
        alt="Logo"\r
        [width]="logoWidth()"\r
        class="sidebar-logo"\r
      />\r
      <!-- <svg [class]="{icon: false}" cIcon class="sidebar-brand-full" height="32" name="logo" title="CoreUI Logo"></svg> -->\r
      <!-- <svg cIcon class="sidebar-brand-narrow" height="32" name="signet" title="CoreUI Logo"></svg> -->\r
    </c-sidebar-brand>\r
  </c-sidebar-header>\r
\r
  <ng-scrollbar pointerEventsMethod="scrollbar" visibility="hover">\r
    <c-sidebar-nav [navItems]="navItems" dropdownMode="path" compact />\r
  </ng-scrollbar>\r
\r
  <c-sidebar-footer\r
    class="border-top d-none d-lg-flex justify-content-center"\r
    style="cursor: pointer"\r
    (click)="toggleSidebarNarrow()"\r
  >\r
...
//# sourceMappingURL=chunk-IUZX37T2.js.map
