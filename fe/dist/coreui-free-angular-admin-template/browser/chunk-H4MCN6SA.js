...
var ListaSediComponent = class _ListaSediComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ListaSediComponent, selectors: [["app-lista-sedi"]], decls: 1, vars: 7, consts: [[3, "stateChange", "columns", "rows", "searchConfig", "paginationConfig", "sortingConfig", "loading", "initialState"]], template: function ListaSediComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "app-datagrid", 0);
        \u0275\u0275listener("stateChange", function ListaSediComponent_Template_app_datagrid_stateChange_0_listener($event) {
          return ctx.loadData($event);
        });
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275property("columns", ctx.columns)("rows", ctx.sedi())("searchConfig", ctx.searchConfig)("paginationConfig", ctx.paginationConfig)("sortingConfig", ctx.sortingConfig)("loading", ctx.datagridLoading())("initialState", ctx.gridState());
      }
...
//# sourceMappingURL=chunk-H4MCN6SA.js.map
