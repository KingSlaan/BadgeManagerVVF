...
import {
  DATAGRID_CONSTANTS,
  DataGridComponent
} from "./chunk-VMRDWUTU.js";
import {
  TessereService,
  UtilsService
} from "./chunk-BWSFI5X7.js";
import {
  SediService
} from "./chunk-J3KVAZOR.js";
import {
...
function ListaTessereComponent_ng_template_4_For_5_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_4_For_5_Conditional_0_Template_li_click_0_listener() {
      ...
      return \u0275\u0275resetView(action_r3.do(row_r4));
    });
  ...
  if (rf & 2) {
    const action_r3 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275classMap(action_r3.color);
    \u0275\u0275advance();
    \u0275\u0275property("cIcon", action_r3.icon)("title", action_r3.title);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", action_r3.title, " ");
  }
}
function ListaTessereComponent_ng_template_4_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ListaTessereComponent_ng_template_4_For_5_Conditional_0_Template, 4, 5, "li", 9);
  }
  if (rf & 2) {
    const action_r3 = ctx.$implicit;
    const row_r4 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275conditional(action_r3.visibility(row_r4) ? 0 : -1);
  }
}
function ListaTessereComponent_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("cIcon", ctx_r4.icons.cilOptions);
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r4.actionsArray);
  }
}
function ListaTessereComponent_ng_template_6_For_2_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_6_For_2_Conditional_0_Template_li_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const action_r7 = \u0275\u0275nextContext().$implicit;
      const row_r8 = \u0275\u0275nextContext().$implicit;
      return \u0275\u0275resetView(action_r7.do(row_r8));
    });
    \u0275\u0275elementStart(1, "span");
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(2, "svg", 11);
  ...
  if (rf & 2) {
    const action_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275classMap(action_r7.color);
    \u0275\u0275advance();
    \u0275\u0275property("cIcon", action_r7.icon)("title", action_r7.title);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", action_r7.title, " ");
  }
}
function ListaTessereComponent_ng_template_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ListaTessereComponent_ng_template_6_For_2_Conditional_0_Template, 4, 5, "li", 13);
  }
  if (rf & 2) {
    const action_r7 = ctx.$implicit;
    const row_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275conditional(action_r7.visibility(row_r8) ? 0 : -1);
  }
}
...
//# sourceMappingURL=chunk-RYG5IGIA.js.map
