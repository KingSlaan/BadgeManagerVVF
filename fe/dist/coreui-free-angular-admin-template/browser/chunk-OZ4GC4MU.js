...
var _c2 = (a0, a1, a2) => ({ $implicit: a0, row: a1, remove: a2 });
var _c3 = () => [5, 10, 25, 50];
var _c4 = (a0, a1, a2) => ({ $implicit: a0, row: a1, close: a2 });
...
function DataGridComponent_Conditional_8_For_7_Conditional_0_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function DataGridComponent_Conditional_8_For_7_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, DataGridComponent_Conditional_8_For_7_Conditional_0_ng_container_0_Template, 1, 0, "ng-container", 46);
  }
  if (rf & 2) {
    const row_r21 = \u0275\u0275nextContext().$implicit;
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngTemplateOutlet", ctx_r3.selectionSummaryConfig().template)("ngTemplateOutletContext", \u0275\u0275pureFunction3(2, _c2, row_r21, row_r21, ctx_r3.removeSelectedRow.bind(ctx_r3)));
  }
}
function DataGridComponent_Conditional_8_For_7_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r22 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 52);
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "button", 53);
    \u0275\u0275listener("click", function DataGridComponent_Conditional_8_For_7_Conditional_1_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r22);
      const row_r21 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.removeSelectedRow(row_r21));
    });
    \u0275\u0275text(3, " \xD7 ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r3.getSelectionLabel(row_r21), " ");
  }
}
function DataGridComponent_Conditional_8_For_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, DataGridComponent_Conditional_8_For_7_Conditional_0_Template, 1, 6, "ng-container")(1, DataGridComponent_Conditional_8_For_7_Conditional_1_Template, 4, 1, "span", 52);
  }
  if (rf & 2) {
    let tmp_11_0;
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275conditional(((tmp_11_0 = ctx_r3.selectionSummaryConfig()) == null ? null : tmp_11_0.template) ? 0 : 1);
  }
}
function DataGridComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(6, DataGridComponent_Conditional_8_For_7_Template, 2, 1, null, null, _forTrack3, true);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_1_0;
...
function DataGridComponent_Conditional_9_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275repeater(((tmp_3_0 = ctx_r3.paginationConfig()) == null ? null : tmp_3_0.pageSizes) ?? \u0275\u0275pureFunction0(1, _c3));
  }
}
...
function DataGridComponent_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", ctx_r3.contextMenuConfig().template)("ngTemplateOutletContext", \u0275\u0275pureFunction3(6, _c4, ctx_r3.contextMenuRow(), ctx_r3.contextMenuRow(), ctx_r3.closeContextMenu.bind(ctx_r3)));
  }
}
var DataGridComponent = class _DataGridComponent {
  constructor() {
    ...
    this.initialState = input(null, ...ngDevMode ? [{ debugName: "initialState" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  changePage(page) {
    ...
    this.stateChange.emit(this.buildGridState(page, pagination.pageSize));
  }
  changePageSize(size) {
    this.stateChange.emit(this.buildGridState(1, Number(size)));
  }
  sort(column) {
  ...
  toggleAllRows(event) {
    ...
    if (this.areAllRowsSelected()) {
      this.selectedRows.update((selected) => selected.filter((selectedRow) => !displayedRows.some((displayedRow) => this.getRowKey(displayedRow) === this.getRowKey(selectedRow))));
    } else {
      this.selectedRows.update((selected) => {
        const newRows = displayedRows.filter((displayedRow) => !selected.some((selectedRow) => this.getRowKey(selectedRow) === this.getRowKey(displayedRow)));
        return [
          ...selected,
          ...newRows
        ];
  ...
  static {
    ...
    }, inputs: { loading: [1, "loading"], rows: [1, "rows"], columns: [1, "columns"], paginationConfig: [1, "paginationConfig"], searchConfig: [1, "searchConfig"], sortingConfig: [1, "sortingConfig"], loadingConfig: [1, "loadingConfig"], emptyStateConfig: [1, "emptyStateConfig"], toolbarConfig: [1, "toolbarConfig"], initialState: [1, "initialState"], selectionSummaryConfig: [1, "selectionSummaryConfig"], contextMenuConfig: [1, "contextMenuConfig"], selectionConfig: [1, "selectionConfig"] }, outputs: { selectionChange: "selectionChange", stateChange: "stateChange" }, decls: 11, vars: 6, consts: [[1, "my-4"], ["cForm", "", "cRow", "", 3, "gutter"], [1, "datagrid-empty-state"], ["cTable", ""], [1, "datagrid-selection-summary", "mb-3", 3, "max-height"], [1, "d-flex", "align-items-center", "justify-content-between", "gap-3", "flex-wrap"], [1, "datagrid-context-menu", 3, "left", "top"], [3, "xs"], ["xs", "2"], [1, "d-flex", "gap-2", "flex-wrap"], ["cButton", "", "color", "primary", "variant", "ghost", "shape", "rounded-pill", 3, "click"], ["title", "Ricerca", 3, "cIcon"], ["cButton", "", "color", "danger", "variant", "ghost", "shape", "rounded-pill", 3, "click"], ["title", "Pulisci Filtri", 3, "cIcon"], ["cFormControl", "", "type", "text", 3, "name", "ngModel", "placeholder"], ["cSelect", "", 3, "name", "ngModel"], ["min", "1900-01-01", "max", "2100-12-31", 3, "name", "ngModel", "placeholder"], [1, "form-check", "mt-2"], [3, "name", "ngModel", "placeholder", "options", "multiple"], ["cFormControl", "", "type", "text", 3, "ngModelChange", "keydown", "name", "ngModel", "placeholder"], ["cSelect", "", 3, "ngModelChange", "name", "ngModel"], ["value", ""], [3, "value"], ["min", "1900-01-01", "max", "2100-12-31", 3, "ngModelChange", "keydown", "name", "ngModel", "placeholder"], ["cFormCheckInput", "", "type", "checkbox", 3, "ngModelChange", "name", "ngModel"], [1, "form-check-label"], [3, "ngModelChange", "name", "ngModel", "placeholder", "options", "multiple"], [1, "d-flex", "gap-2", "mb-3", "flex-wrap", "justify-content-end"], ["cButton", "", "variant", "ghost", "shape", "rounded-pill", "size", "sm", 3, "color", "disabled"], ["cButton", "", "variant", "ghost", "shape", "rounded-pill", "size", "sm", 3, "click", "color", "disabled"], ["title", "Pulisci Filtri", "size", "3xl", 1, "mb-3", "text-medium-emphasis", 3, "cIcon"], [1, "text-medium-emphasis"], [2, "width", "48px"], [3, "width", "sortable"], [1, "datagrid-loading-overlay"], [3, "datagrid-row-even", "datagrid-row-odd"], ["cFormCheckInput", "", "type", "checkbox", 3, "checked"], ["cFormCheckInput", "", "type", "checkbox", 3, "click", "checked"], [3, "click"], [1, "d-flex", "align-items-center", "gap-2"], [1, "sort-icon"], ["size", "sm"], [1, "ms-2"], [3, "contextmenu", "click"], [3, "class"], [3, "innerHTML"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "datagrid-selection-summary", "mb-3"], [1, "d-flex", "justify-content-between", "align-items-center", "mb-2"], ["cButton", "", "size", "sm", "color", "secondary", "variant", "ghost"], [1, "d-flex", "flex-wrap", "gap-2"], ["cButton", "", "size", "sm", "color", "secondary", "variant", "ghost", 3, "click"], [1, "datagrid-selection-chip"], ["type", "button", 1, "datagrid-selection-chip-close", 3, "click"], [1, "d-flex", "gap-1", "align-items-center", "text-body-secondary", "small"], [1, "d-flex", "gap-1", "align-items-center"], ["cButton", "", "color", "secondary", "size", "sm", "variant", "ghost", 3, "click", "disabled"], ["cSelect", "", 2, "width", "120px", 3, "change", "value"], [1, "px-2", "text-body-secondary"], ["cButton", "", "size", "sm", "variant", "ghost", 3, "color"], ["cButton", "", "size", "sm", "variant", "ghost", 3, "click", "color"], [1, "datagrid-context-menu", 3, "click"]], template: function DataGridComponent_Template(rf, ctx) {
      if (rf & 1) {
...
\r
        <div class="d-flex flex-wrap gap-2">\r
          @for (row of selectedRows(); track getRowKey(row)) {\r
            @if (selectionSummaryConfig()?.template) {\r
              <ng-container\r
                *ngTemplateOutlet="\r
                  selectionSummaryConfig()!.template;\r
                  context: {\r
                    $implicit: row,\r
                    row: row,\r
                    remove: removeSelectedRow.bind(this),\r
                  }\r
                "\r
              />\r
            } @else {\r
...
//# sourceMappingURL=chunk-OZ4GC4MU.js.map
