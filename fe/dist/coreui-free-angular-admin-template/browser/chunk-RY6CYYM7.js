  ...
  httpError(status, message) {
    switch (status) {
      case 0:
        ...
        break;
      case 400:
        this.error(message || "Bad request", "400 Errore");
        break;
      case 401:
        this.error(message || "Unauthorized", "401 Errore");
        break;
      case 403:
        this.error(message || "Access denied", "403 Errore");
        break;
      case 404:
        this.error(message || "Resource not found", "404 Errore");
        break;
      case 500:
        this.error(message || "Internal server error", "500 Errore");
        break;
      default:
        this.error(message || "Unexpected error occurred", `Errore ${status}`);
    }
  }
  static {
...
//# sourceMappingURL=chunk-RY6CYYM7.js.map
