...
import "./chunk-FHEW5I55.js";
import "./chunk-KIY36XLL.js";
import {
  cilPencil
...
var ListaUtentiComponent = class _ListaUtentiComponent {
  constructor() {
    ...
    this.persistConfig = UTENTI_PERSIST_CONFIG;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ListaUtentiComponent, selectors: [["app-lista-utenti"]], viewQuery: function ListaUtentiComponent_Query(rf, ctx) {
    ...
    }, decls: 3, vars: 6, consts: [["actionTemplate", ""], [3, "dataRequest", "columns", "rows", "searchConfig", "paginationConfig", "persistConfig", "loading"], ["cButton", "", "color", "primary", "variant", "ghost", "shape", "rounded-pill"], ["title", "Modifica", 3, "cIcon"]], template: function ListaUtentiComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "app-datagrid", 1);
        \u0275\u0275listener("dataRequest", function ListaUtentiComponent_Template_app_datagrid_dataRequest_0_listener($event) {
      ...
      if (rf & 2) {
        \u0275\u0275property("columns", ctx.columns)("rows", ctx.utenti())("searchConfig", ctx.searchConfig)("paginationConfig", ctx.paginationConfig)("persistConfig", ctx.persistConfig)("loading", ctx.datagridLoading());
      }
    }, dependencies: [
      DataGridComponent,
      ButtonDirective,
...
//# sourceMappingURL=chunk-JW4IXMFR.js.map
