...
function createGridToolbar(openModalAggiungi, exportCsv, importCsv) {
  return {
    enabled: true,
    actions: [
      {
...
function createGridColumn(actionTemplate) {
  return [
    ...
    },
    {
      field: "persona",
      header: "Persona",
      render: (row) => `${row.cognome} ${row.nome} <br/> <small> <strong>${row.codiceFiscale} </strong></small>`
    },
    // {
    //   field: 'codiceFiscale',
    //   header: 'CF',
...
function ListaTessereComponent_ng_template_4_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 9);
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_4_Conditional_16_Template_li_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const row_r3 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openModal(ctx_r3.action_const.REMOVE, row_r3.idTessera));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("cIcon", ctx_r3.icons.cilDelete);
  }
}
function ListaTessereComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "c-dropdown")(1, "button", 6);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(2, "svg", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(3, "ul", 8)(4, "li", 9);
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_4_Template_li_click_4_listener() {
      const row_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openModal(ctx_r3.action_const.ASSIGN, row_r3.idTessera));
    });
    \u0275\u0275elementStart(5, "span", 10);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(6, "svg", 7);
    \u0275\u0275text(7, " Assegna Dipendente ");
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(8, "li", 9);
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_4_Template_li_click_8_listener() {
      const row_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openModal(ctx_r3.action_const.ASSIGN_SEDE, row_r3.idTessera));
    });
    \u0275\u0275elementStart(9, "span", 10);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(10, "svg", 11);
    \u0275\u0275text(11, " Cambia Sede ");
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(12, "li", 9);
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_4_Template_li_click_12_listener() {
      const row_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openModal(ctx_r3.action_const.DISABLED, row_r3.idTessera));
    });
    \u0275\u0275elementStart(13, "span", 12);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(14, "svg", 13);
    \u0275\u0275text(15, " Cambia Validit\xE0 ");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(16, ListaTessereComponent_ng_template_4_Conditional_16_Template, 4, 1, "li", 14);
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(17, "li", 9);
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_4_Template_li_click_17_listener() {
      const row_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openHistoryModal(row_r3.idTessera));
    });
    \u0275\u0275elementStart(18, "span", 15);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(19, "svg", 16);
    \u0275\u0275text(20, " Cronologia ");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("cIcon", ctx_r3.icons.cilOptions);
    \u0275\u0275advance(4);
    \u0275\u0275property("cIcon", ctx_r3.icons.cilActionUndo);
    \u0275\u0275advance(4);
    \u0275\u0275property("cIcon", ctx_r3.icons.cilBuilding);
    \u0275\u0275advance(4);
    \u0275\u0275property("cIcon", ctx_r3.icons.cilBan);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(row_r3.codiceFiscale ? 16 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275property("cIcon", ctx_r3.icons.cilHistory);
  }
}
function ListaTessereComponent_ng_template_6_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 19);
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_6_Conditional_13_Template_li_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const row_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openModal(ctx_r3.action_const.REMOVE, row_r7.idTessera));
    });
    \u0275\u0275elementStart(1, "span", 12);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(2, "svg", 17);
...
function ListaTessereComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "ul", 18)(1, "li", 19);
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_6_Template_li_click_1_listener() {
      const row_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openModal(ctx_r3.action_const.ASSIGN, row_r7.idTessera));
    });
    \u0275\u0275elementStart(2, "span", 10);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(3, "svg", 7);
    \u0275\u0275text(4, " Assegna Dipendente ");
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "li", 19);
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_6_Template_li_click_5_listener() {
      const row_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openModal(ctx_r3.action_const.ASSIGN_SEDE, row_r7.idTessera));
    });
    \u0275\u0275elementStart(6, "span", 10);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(7, "svg", 11);
    \u0275\u0275text(8, " Cambia Sede ");
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(9, "li", 19);
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_6_Template_li_click_9_listener() {
      const row_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openModal(ctx_r3.action_const.DISABLED, row_r7.idTessera));
    });
    \u0275\u0275elementStart(10, "span", 12);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(11, "svg", 13);
    \u0275\u0275text(12, " Cambia Validit\xE0 ");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(13, ListaTessereComponent_ng_template_6_Conditional_13_Template, 4, 1, "li", 20);
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(14, "li", 19);
    \u0275\u0275listener("click", function ListaTessereComponent_ng_template_6_Template_li_click_14_listener() {
      const row_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openHistoryModal(row_r7.idTessera));
    });
    \u0275\u0275elementStart(15, "span", 15);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(16, "svg", 16);
    \u0275\u0275text(17, " Cronologia ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("cIcon", ctx_r3.icons.cilBan);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(row_r7.codiceFiscale ? 13 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275property("cIcon", ctx_r3.icons.cilHistory);
  }
}
var ListaTessereComponent = class _ListaTessereComponent {
  constructor() {
    ...
    this.utilsService = inject(UtilsService);
    this.icons = { cilBan, cilPlus, cilDelete, cilPencil, cilActionUndo, cilSearch, cilHistory, cilOptions, cilBuilding };
    ...
    this.columns = [];
    this.toolbarConfig = createGridToolbar(() => this.openModalAggiungi(), () => this.exportCsv(), () => this.importCsv());
  ...
  getInitialRequest() {
    ...
    return {
      filters: Object.entries(state.filters ?? {}).filter(([_, value]) => value !== null && value !== void 0 && value !== "").map(([field, value]) => ({
        field,
        operator: "contains",
        value: String(value)
      })),
  ...
  static {
    ...
    }, decls: 8, vars: 18, consts: [["actionTemplate", ""], ["contextActionTemplate", ""], [3, "dataRequest", "columns", "rows", "searchConfig", "toolbarConfig", "paginationConfig", "sortingConfig", "loadingConfig", "persistConfig", "loading", "emptyStateConfig", "contextMenuConfig"], [3, "visibleChange", "saved", "visible", "mode", "tesseraSelected", "sediList"], [3, "visibleChange", "saved", "visible"], [3, "visibleChange", "visible", "tesseraSelectedHistory"], ["cButton", "", "color", "secondary", "variant", "ghost", "shape", "rounded-pill", "cDropdownToggle", "", "direction", "dropend"], ["title", "Assegna Dipendente", 3, "cIcon"], ["cDropdownMenu", ""], ["cDropdownItem", "", 3, "click"], [1, "text-info"], ["title", "Cambia Sede", 3, "cIcon"], [1, "text-danger"], ["title", "Cambia Validit\xE0", 3, "cIcon"], ["cDropdownItem", ""], [1, "text-secondary"], ["title", "Cronologia", 3, "cIcon"], ["title", "Disuso", 3, "cIcon"], ["cListGroup", "", 1, "context-menu-list"], ["cListGroupItem", "", "action", "", 1, "context-menu-item", 3, "click"], ["cListGroupItem", "", "action", "", 1, "context-menu-item"]], template: function ListaTessereComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "app-datagrid", 2);
        \u0275\u0275listener("dataRequest", function ListaTessereComponent_Template_app_datagrid_dataRequest_0_listener($event) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(4, ListaTessereComponent_ng_template_4_Template, 21, 6, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(6, ListaTessereComponent_ng_template_6_Template, 18, 5, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        \u0275\u0275property("columns", ctx.columns)("rows", ctx.tessere())("searchConfig", ctx.searchConfig)("toolbarConfig", ctx.toolbarConfig)("paginationConfig", ctx.paginationConfig)("sortingConfig", ctx.sortingConfig)("loadingConfig", ctx.loadingConfig)("persistConfig", ctx.persistConfig)("loading", ctx.datagridLoading())("emptyStateConfig", ctx.emptyStateConfig)("contextMenuConfig", ctx.contextMenuConfig);
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ListaTessereComponent, [{
    ...
    args: [{ selector: "app-lista-tessere", imports: [
      ...
      ListGroupDirective,
      ListGroupItemDirective
    ], standalone: true, template: '<app-datagrid\r\n  [columns]="columns"\r\n  [rows]="tessere()"\r\n  [searchConfig]="searchConfig"\r\n  [toolbarConfig]="toolbarConfig"\r\n  [paginationConfig]="paginationConfig"\r\n  [sortingConfig]="sortingConfig"\r\n  [loadingConfig]="loadingConfig"\r\n  [persistConfig]="persistConfig"\r\n  [loading]="datagridLoading()"\r\n  [emptyStateConfig]="emptyStateConfig"\r\n  (dataRequest)="loadData($event)"\r\n  [contextMenuConfig]="contextMenuConfig"\r\n/>\r\n\r\n<app-tessera-modal-cmp\r\n  [(visible)]="isModalOpen"\r\n  [mode]="mode"\r\n  [tesseraSelected]="tesseraSelected()"\r\n  [sediList]="sedi()"\r\n  (saved)="refresh()"\r\n></app-tessera-modal-cmp>\r\n\r\n<app-tessera-aggiungi\r\n  [(visible)]="isModalAggiungiOpen"\r\n  (saved)="refresh()"\r\n></app-tessera-aggiungi>\r\n\r\n<app-tessera-history\r\n  [(visible)]="isModalHistoryOpen"\r\n  [tesseraSelectedHistory]="tesseraHistory()"\r\n></app-tessera-history>\r\n\r\n<ng-template #actionTemplate let-row>\r\n  <c-dropdown>\r\n    <button\r\n      cButton\r\n      color="secondary"\r\n      variant="ghost"\r\n      shape="rounded-pill"\r\n      cDropdownToggle\r\n      direction="dropend"\r\n    >\r\n      <svg [cIcon]="icons.cilOptions" title="Assegna Dipendente"></svg>\r\n    </button>\r\n\r\n    <ul cDropdownMenu>\r\n      <li cDropdownItem (click)="openModal(action_const.ASSIGN, row.idTessera)">\r\n        <span class="text-info">\r\n          <svg [cIcon]="icons.cilActionUndo" title="Assegna Dipendente"></svg>\r\n          Assegna Dipendente\r\n        </span>\r\n      </li>\r\n      <li\r\n        cDropdownItem\r\n        (click)="openModal(action_const.ASSIGN_SEDE, row.idTessera)"\r\n      >\r\n        <span class="text-info">\r\n          <svg [cIcon]="icons.cilBuilding" title="Cambia Sede"></svg>\r\n          Cambia Sede\r\n        </span>\r\n      </li>\r\n      <li\r\n        cDropdownItem\r\n        (click)="openModal(action_const.DISABLED, row.idTessera)"\r\n      >\r\n        <span class="text-danger">\r\n          <svg [cIcon]="icons.cilBan" title="Cambia Validit\xE0"></svg>\r\n          Cambia Validit\xE0\r\n        </span>\r\n      </li>\r\n      @if (row.codiceFiscale) {\r\n        <li\r\n          cDropdownItem\r\n          (click)="openModal(action_const.REMOVE, row.idTessera)"\r\n        >\r\n          <span class="text-danger">\r\n            <svg [cIcon]="icons.cilDelete" title="Disuso"></svg>\r\n            Disuso\r\n          </span>\r\n        </li>\r\n      }\r\n      <li cDropdownItem (click)="openHistoryModal(row.idTessera)">\r\n        <span class="text-secondary">\r\n          <svg [cIcon]="icons.cilHistory" title="Cronologia"></svg>\r\n          Cronologia\r\n        </span>\r\n      </li>\r\n    </ul>\r\n  </c-dropdown>\r\n</ng-template>\r\n\r\n<ng-template #contextActionTemplate let-row>\r\n  <ul cListGroup class="context-menu-list">\r\n    <li\r\n      cListGroupItem\r\n      action\r\n      (click)="openModal(action_const.ASSIGN, row.idTessera)"\r\n      class="context-menu-item"\r\n    >\r\n      <span class="text-info">\r\n        <svg [cIcon]="icons.cilActionUndo" title="Assegna Dipendente"></svg>\r\n        Assegna Dipendente\r\n      </span>\r\n    </li>\r\n    <li\r\n      cListGroupItem\r\n      action\r\n      (click)="openModal(action_const.ASSIGN_SEDE, row.idTessera)"\r\n      class="context-menu-item"\r\n    >\r\n      <span class="text-info">\r\n        <svg [cIcon]="icons.cilBuilding" title="Cambia Sede"></svg>\r\n        Cambia Sede\r\n      </span>\r\n    </li>\r\n    <li\r\n      cListGroupItem\r\n      action\r\n      (click)="openModal(action_const.DISABLED, row.idTessera)"\r\n      class="context-menu-item"\r\n    >\r\n      <span class="text-danger">\r\n        <svg [cIcon]="icons.cilBan" title="Cambia Validit\xE0"></svg>\r\n        Cambia Validit\xE0\r\n      </span>\r\n    </li>\r\n    @if (row.codiceFiscale) {\r\n      <li\r\n        cListGroupItem\r\n        action\r\n        (click)="openModal(action_const.REMOVE, row.idTessera)"\r\n        class="context-menu-item"\r\n      >\r\n        <span class="text-danger">\r\n          <svg [cIcon]="icons.cilDelete" title="Disuso"></svg>\r\n          Disuso\r\n        </span>\r\n      </li>\r\n    }\r\n    <li\r\n      cListGroupItem\r\n      action\r\n      (click)="openHistoryModal(row.idTessera)"\r\n      class="context-menu-item"\r\n    >\r\n      <span class="text-secondary">\r\n        <svg [cIcon]="icons.cilHistory" title="Cronologia"></svg>\r\n        Cronologia\r\n      </span>\r\n    </li>\r\n  </ul>\r\n</ng-template>\r\n' }]
  }], null, { actionTemplate: [{
    type: ViewChild,
    args: ["actionTemplate", {
      static: true
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ListaTessereComponent, { className: "ListaTessereComponent", filePath: "src/app/views/pages/lista-tessere/lista-tessere.component.ts", lineNumber: 49 });
})();
export {
  ListaTessereComponent
};
//# sourceMappingURL=chunk-6LWOQQLA.js.map
