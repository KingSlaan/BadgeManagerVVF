...
function DefaultFooterComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 2, ctx_r0.versionInfo().buildDate, "d MMM y HH:mm:ss"), " ");
  }
}
function DefaultFooterComponent_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.versionInfoBE().version, " ");
    \u0275\u0275advance(2);
...
function DefaultFooterComponent_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" Today ", ctx_r0.weatherIcon(ctx_r0.weatherInfo().todayCode), " ", ctx_r0.weatherInfo().todayTemp, "\xB0C ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" Tomorrow ", ctx_r0.weatherIcon(ctx_r0.weatherInfo().tomorrowCode), " ", ctx_r0.weatherInfo().tomorrowTemp, "\xB0C ");
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DefaultFooterComponent, selectors: [["app-default-footer"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 23, vars: 3, consts: [[1, "footer-container"], [1, "footer-version-section"], [1, "version-card"], [1, "version-title"], [1, "version-number"], ["href", "https://bloob.io/yatch", "target", "_blank"], [1, "version-date"]], template: function DefaultFooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(8, "Backend");
        \u0275\u0275domElementEnd();
        \u0275\u0275conditionalCreate(9, DefaultFooterComponent_Conditional_9_Template, 4, 2);
        \u0275\u0275domElementEnd();
        \u0275\u0275domElementStart(10, "div", 2)(11, "div", 3);
        \u0275\u0275text(12, "Meteo");
        \u0275\u0275domElementEnd();
        \u0275\u0275conditionalCreate(13, DefaultFooterComponent_Conditional_13_Template, 4, 4)(14, DefaultFooterComponent_Conditional_14_Template, 4, 0);
        \u0275\u0275domElementEnd()();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275conditional(ctx.weatherInfo() ? 13 : 14);
      }
...
var version_default = {
  version: "3.0.1-BloodRage",
  environment: "dev",
  buildDate: "2026-06-18T08:56:28.494Z"
};
...
\r
  <ng-scrollbar pointerEventsMethod="scrollbar" visibility="hover">\r
    <c-sidebar-nav [navItems]="navItems" dropdownMode="close" compact />\r
  </ng-scrollbar>\r
\r
  <c-sidebar-footer\r
...
//# sourceMappingURL=chunk-CEHCHYAY.js.map
