...
var _c0 = () => [];
var _c1 = (a0, a1) => ({ $implicit: a0, row: a1 });
var _c2 = () => [5, 10, 25, 50];
...
function DataGridComponent_Conditional_2_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "-");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, DataGridComponent_Conditional_2_For_2_Conditional_2_For_4_Template, 2, 2, "option", 21, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const f_r3 = \u0275\u0275nextContext().$implicit;
...
function DataGridComponent_Conditional_2_For_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-datepicker", 22);
...
function DataGridComponent_Conditional_2_For_2_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-autocomplete-select", 25);
...
function DataGridComponent_Conditional_2_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "c-col", 6);
    \u0275\u0275conditionalCreate(1, DataGridComponent_Conditional_2_For_2_Conditional_1_Template, 1, 3, "input", 13);
    \u0275\u0275conditionalCreate(2, DataGridComponent_Conditional_2_For_2_Conditional_2_Template, 5, 2, "select", 14);
    \u0275\u0275conditionalCreate(3, DataGridComponent_Conditional_2_For_2_Conditional_3_Template, 1, 3, "app-datepicker", 15);
    \u0275\u0275conditionalCreate(4, DataGridComponent_Conditional_2_For_2_Conditional_4_Template, 4, 3, "div", 16);
    \u0275\u0275conditionalCreate(5, DataGridComponent_Conditional_2_For_2_Conditional_5_Template, 1, 6, "app-autocomplete-select", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DataGridComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, DataGridComponent_Conditional_2_For_2_Template, 6, 6, "c-col", 6, _forTrack0);
    \u0275\u0275elementStart(3, "c-col", 7)(4, "div", 8)(5, "button", 9);
...
function DataGridComponent_Conditional_3_For_3_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DataGridComponent_Conditional_3_For_3_Conditional_0_Template_button_click_0_listener() {
      ...
      return \u0275\u0275resetView(action_r11.action());
    });
    \u0275\u0275conditionalCreate(1, DataGridComponent_Conditional_3_For_3_Conditional_0_Conditional_1_Template, 1, 1, ":svg:svg", 12);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const action_r11 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("color", action_r11.color || "primary")("disabled", action_r11.disabled == null ? null : action_r11.disabled());
    \u0275\u0275advance();
...
function DataGridComponent_Conditional_3_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, DataGridComponent_Conditional_3_For_3_Conditional_0_Template, 3, 4, "button", 27);
  }
  if (rf & 2) {
    const action_r11 = ctx.$implicit;
    \u0275\u0275conditional(!action_r11.visible || action_r11.visible() ? 0 : -1);
  }
}
...
function DataGridComponent_Conditional_6_For_4_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r3.getSortIcon(column_r13), " ");
  }
}
function DataGridComponent_Conditional_6_For_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "th", 34);
    \u0275\u0275listener("click", function DataGridComponent_Conditional_6_For_4_Template_th_click_0_listener() {
      const column_r13 = \u0275\u0275restoreView(_r12).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.sort(column_r13));
    });
    \u0275\u0275elementStart(1, "div", 35);
    \u0275\u0275text(2);
    \u0275\u0275conditionalCreate(3, DataGridComponent_Conditional_6_For_4_Conditional_3_Template, 2, 1, "span", 36);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const column_r13 = ctx.$implicit;
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275styleProp("width", column_r13.width);
    \u0275\u0275classProp("sortable", column_r13.sortable);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", column_r13.header, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.sortingEnabled() && column_r13.sortable ? 3 : -1);
  }
}
function DataGridComponent_Conditional_6_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32);
    \u0275\u0275element(1, "c-spinner", 37);
...
function DataGridComponent_Conditional_6_For_8_For_2_Conditional_1_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function DataGridComponent_Conditional_6_For_8_For_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, DataGridComponent_Conditional_6_For_8_For_2_Conditional_1_ng_container_0_Template, 1, 0, "ng-container", 42);
  }
  if (rf & 2) {
    const column_r16 = \u0275\u0275nextContext().$implicit;
    const row_r15 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("ngTemplateOutlet", column_r16.template)("ngTemplateOutletContext", \u0275\u0275pureFunction2(2, _c1, row_r15, row_r15));
  }
}
function DataGridComponent_Conditional_6_For_8_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 41);
  }
  if (rf & 2) {
    ...
    const row_r15 = \u0275\u0275nextContext().$implicit;
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("innerHTML", ctx_r3.renderCell(row_r15, column_r16), \u0275\u0275sanitizeHtml);
  }
}
function DataGridComponent_Conditional_6_For_8_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275conditionalCreate(1, DataGridComponent_Conditional_6_For_8_For_2_Conditional_1_Template, 1, 5, "ng-container")(2, DataGridComponent_Conditional_6_For_8_For_2_Conditional_2_Template, 1, 1, "span", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const column_r16 = ctx.$implicit;
    \u0275\u0275classMap(column_r16.className);
    \u0275\u0275advance();
    \u0275\u0275conditional(column_r16.template ? 1 : 2);
  }
}
function DataGridComponent_Conditional_6_For_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 39);
    \u0275\u0275listener("contextmenu", function DataGridComponent_Conditional_6_For_8_Template_tr_contextmenu_0_listener($event) {
      const row_r15 = \u0275\u0275restoreView(_r14).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.openContextMenu($event, row_r15));
    })("click", function DataGridComponent_Conditional_6_For_8_Template_tr_click_0_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.closeContextMenu());
    });
    \u0275\u0275repeaterCreate(1, DataGridComponent_Conditional_6_For_8_For_2_Template, 3, 3, "td", 40, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const \u0275$index_103_r17 = ctx.$index;
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("datagrid-row-even", \u0275$index_103_r17 % 2 === 0)("datagrid-row-odd", \u0275$index_103_r17 % 2 !== 0);
    \u0275\u0275advance();
...
function DataGridComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(3, DataGridComponent_Conditional_6_For_4_Template, 4, 6, "th", 31, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "tbody");
    \u0275\u0275conditionalCreate(6, DataGridComponent_Conditional_6_Conditional_6_Template, 4, 1, "div", 32);
    \u0275\u0275repeaterCreate(7, DataGridComponent_Conditional_6_For_8_Template, 3, 4, "tr", 33, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275repeater(ctx_r3.columns());
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r3.loading() ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r3.displayedRows());
  }
}
function DataGridComponent_Conditional_8_Conditional_1_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 21);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", size_r20, " ");
  }
}
function DataGridComponent_Conditional_8_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 35)(1, "span");
    \u0275\u0275text(2, "Rows per page");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "select", 46);
    \u0275\u0275listener("change", function DataGridComponent_Conditional_8_Conditional_1_Template_select_change_3_listener($event) {
      \u0275\u0275restoreView(_r19);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.changePageSize($event.target.value));
    });
    \u0275\u0275repeaterCreate(4, DataGridComponent_Conditional_8_Conditional_1_For_5_Template, 2, 2, "option", 21, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_2_0;
...
function DataGridComponent_Conditional_8_For_17_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function DataGridComponent_Conditional_8_For_17_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 49);
    \u0275\u0275listener("click", function DataGridComponent_Conditional_8_For_17_Conditional_1_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r21);
      const p_r22 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.changePage(p_r22));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const p_r22 = \u0275\u0275nextContext().$implicit;
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("color", p_r22 === ctx_r3.paginationConfig().page ? "primary" : "secondary");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", p_r22, " ");
  }
}
function DataGridComponent_Conditional_8_For_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, DataGridComponent_Conditional_8_For_17_Conditional_0_Template, 2, 0, "span", 47)(1, DataGridComponent_Conditional_8_For_17_Conditional_1_Template, 2, 2, "button", 48);
  }
  if (rf & 2) {
    const p_r22 = ctx.$implicit;
    \u0275\u0275conditional(p_r22 === "ellipsis" ? 0 : 1);
  }
}
function DataGridComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, DataGridComponent_Conditional_8_Conditional_1_Template, 6, 2, "div", 35);
    ...
    \u0275\u0275listener("click", function DataGridComponent_Conditional_8_Template_button_click_14_listener() {
      \u0275\u0275restoreView(_r18);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(15, " Previous ");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(16, DataGridComponent_Conditional_8_For_17_Template, 2, 1, null, null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementStart(18, "button", 45);
    \u0275\u0275listener("click", function DataGridComponent_Conditional_8_Template_button_click_18_listener() {
      \u0275\u0275restoreView(_r18);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.changePage(ctx_r3.paginationConfig().page + 1));
    });
...
function DataGridComponent_Conditional_9_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function DataGridComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DataGridComponent_Conditional_9_Template_div_click_0_listener($event) {
      return $event.stopPropagation();
    });
    \u0275\u0275template(1, DataGridComponent_Conditional_9_ng_container_1_Template, 1, 0, "ng-container", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
var DataGridComponent = class _DataGridComponent {
  ...
  static {
    ...
    }, inputs: { loading: [1, "loading"], rows: [1, "rows"], columns: [1, "columns"], paginationConfig: [1, "paginationConfig"], searchConfig: [1, "searchConfig"], sortingConfig: [1, "sortingConfig"], loadingConfig: [1, "loadingConfig"], emptyStateConfig: [1, "emptyStateConfig"], toolbarConfig: [1, "toolbarConfig"], persistConfig: [1, "persistConfig"], contextMenuConfig: [1, "contextMenuConfig"] }, outputs: { dataRequest: "dataRequest" }, decls: 10, vars: 5, consts: [[1, "my-4"], ["cForm", "", "cRow", "", 3, "gutter"], [1, "datagrid-empty-state"], ["cTable", ""], [1, "d-flex", "align-items-center", "justify-content-between", "gap-3", "flex-wrap"], [1, "datagrid-context-menu", 3, "left", "top"], [3, "xs"], ["xs", "2"], [1, "d-flex", "gap-2", "flex-wrap"], ["cButton", "", "color", "primary", "variant", "ghost", "shape", "rounded-pill", 3, "click"], ["title", "Ricerca", 3, "cIcon"], ["cButton", "", "color", "danger", "variant", "ghost", "shape", "rounded-pill", 3, "click"], ["title", "Pulisci Filtri", 3, "cIcon"], ["cFormControl", "", "type", "text", 3, "name", "ngModel", "placeholder"], ["cSelect", "", 3, "name", "ngModel"], ["min", "1900-01-01", "max", "2100-12-31", 3, "name", "ngModel", "placeholder"], [1, "form-check", "mt-2"], [3, "name", "ngModel", "placeholder", "options", "multiple"], ["cFormControl", "", "type", "text", 3, "ngModelChange", "keydown", "name", "ngModel", "placeholder"], ["cSelect", "", 3, "ngModelChange", "name", "ngModel"], ["value", ""], [3, "value"], ["min", "1900-01-01", "max", "2100-12-31", 3, "ngModelChange", "keydown", "name", "ngModel", "placeholder"], ["cFormCheckInput", "", "type", "checkbox", 3, "ngModelChange", "name", "ngModel"], [1, "form-check-label"], [3, "ngModelChange", "name", "ngModel", "placeholder", "options", "multiple"], [1, "d-flex", "gap-2", "mb-3", "flex-wrap", "justify-content-end"], ["cButton", "", "variant", "ghost", "shape", "rounded-pill", "size", "sm", 3, "color", "disabled"], ["cButton", "", "variant", "ghost", "shape", "rounded-pill", "size", "sm", 3, "click", "color", "disabled"], ["title", "Pulisci Filtri", "size", "3xl", 1, "mb-3", "text-medium-emphasis", 3, "cIcon"], [1, "text-medium-emphasis"], [3, "width", "sortable"], [1, "datagrid-loading-overlay"], [3, "datagrid-row-even", "datagrid-row-odd"], [3, "click"], [1, "d-flex", "align-items-center", "gap-2"], [1, "sort-icon"], ["size", "sm"], [1, "ms-2"], [3, "contextmenu", "click"], [3, "class"], [3, "innerHTML"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "d-flex", "gap-1", "align-items-center", "text-body-secondary", "small"], [1, "d-flex", "gap-1", "align-items-center"], ["cButton", "", "color", "secondary", "size", "sm", "variant", "ghost", 3, "click", "disabled"], ["cSelect", "", 2, "width", "120px", 3, "change", "value"], [1, "px-2", "text-body-secondary"], ["cButton", "", "size", "sm", "variant", "ghost", 3, "color"], ["cButton", "", "size", "sm", "variant", "ghost", 3, "click", "color"], [1, "datagrid-context-menu", 3, "click"]], template: function DataGridComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(5, DataGridComponent_Conditional_5_Template, 6, 3, "div", 2)(6, DataGridComponent_Conditional_6_Template, 9, 1, "table", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(7, "c-card-footer");
        \u0275\u0275conditionalCreate(8, DataGridComponent_Conditional_8_Template, 20, 6, "div", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(9, DataGridComponent_Conditional_9_Template, 2, 10, "div", 5);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_0_0;
        ...
        \u0275\u0275advance(3);
        \u0275\u0275conditional(((tmp_3_0 = ctx.paginationConfig()) == null ? null : tmp_3_0.enabled) ? 8 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.contextMenuOpen() && ctx.contextMenuRow() ? 9 : -1);
      }
    }, dependencies: [
      CommonModule,
      NgTemplateOutlet,
...
//# sourceMappingURL=chunk-7B2ENRGV.js.map
