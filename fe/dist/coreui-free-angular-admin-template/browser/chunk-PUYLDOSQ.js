...
import {
  DATAGRID_CONSTANTS,
  DataGridComponent
} from "./chunk-SSA7BT6P.js";
import {
  TessereService,
  UtilsService
} from "./chunk-ALLYUNOH.js";
import {
  SediService
} from "./chunk-AKBWSBMT.js";
import {
...
var ListaTessereComponent = class _ListaTessereComponent {
  ...
  updateUrlFromRequest(request) {
    ...
    request.filters.forEach((filter) => {
      if (Array.isArray(filter.value)) {
        queryParams[filter.field] = filter.value.length ? filter.value.join(",") : null;
        return;
      }
      queryParams[filter.field] = filter.value !== null && filter.value !== void 0 && filter.value !== "" ? filter.value : null;
    });
  ...
  static {
    ...
    }, decls: 8, vars: 8, consts: [["actionTemplate", ""], ["contextActionTemplate", ""], [3, "columns", "rows", "searchConfig", "toolbarConfig", "paginationConfig", "sortingConfig", "loadingConfig", "persistConfig", "loading", "emptyStateConfig", "contextMenuConfig", "selectionConfig"], [3, "visibleChange", "saved", "visible", "mode", "tesseraSelected", "sediList"], [3, "visibleChange", "saved", "visible"], [3, "visibleChange", "visible", "tesseraSelectedHistory"], [3, "dataRequest", "selectionChange", "columns", "rows", "searchConfig", "toolbarConfig", "paginationConfig", "sortingConfig", "loadingConfig", "persistConfig", "loading", "emptyStateConfig", "contextMenuConfig", "selectionConfig"], ["cButton", "", "color", "secondary", "variant", "ghost", "shape", "rounded-pill", "cDropdownToggle", "", "direction", "dropend"], ["title", "Opzioni", 3, "cIcon"], ["cDropdownMenu", ""], ["cDropdownItem", ""], ["cDropdownItem", "", 3, "click"], [3, "cIcon", "title"], ["cListGroup", "", 1, "context-menu-list"], ["cListGroupItem", "", "action", "", 1, "context-menu-item"], ["cListGroupItem", "", "action", "", 1, "context-menu-item", 3, "click"]], template: function ListaTessereComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275conditionalCreate(0, ListaTessereComponent_Conditional_0_Template, 1, 12, "app-datagrid", 2);
...
//# sourceMappingURL=chunk-PUYLDOSQ.js.map
