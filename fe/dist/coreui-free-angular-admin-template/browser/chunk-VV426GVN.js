...
var DashboardService = class _DashboardService {
   ...
   */
  getStatistiche() {
    return this.http.get(`${this.apiUrl}/getStatisticheTessere`);
  }
  getStatisticheSede() {
    return this.http.get(`${this.apiUrl}/getConteggioTessereSedi`);
  }
  static {
...
var ChartjsComponent = class _ChartjsComponent {
   ...
   * @default true
   */
  customTooltips = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
   ...
   * @default null
   */
  height = input(null, __spreadProps(__spreadValues({}, ngDevMode ? {
    debugName: "height"
  } : (
    /* istanbul ignore next */
    {}
   ...
   */
  idInput = input(`c-chartjs-${nextId++}`, __spreadProps(__spreadValues({}, ngDevMode ? {
    debugName: "idInput"
  } : (
    /* istanbul ignore next */
    {}
   ...
   * @default {}
   */
  optionsInput = input({}, __spreadProps(__spreadValues({}, ngDevMode ? {
   ...
   * @default false
   */
  redraw = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
    debugName: "redraw"
  } : (
    /* istanbul ignore next */
    {}
   ...
   * @default null
   */
  width = input(null, __spreadProps(__spreadValues({}, ngDevMode ? {
    debugName: "width"
  } : (
    /* istanbul ignore next */
    {}
   ...
   * @default true
   */
  wrapper = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
    debugName: "wrapper"
  } : (
    /* istanbul ignore next */
    {}
  ...
  chart;
  ctx = computed(() => this.canvasElement()?.nativeElement.getContext("2d"), ...ngDevMode ? [{
    debugName: "ctx"
  }] : (
    /* istanbul ignore next */
    []
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    hostBindings: function ChartjsComponent_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        \u0275\u0275classProp("chart-wrapper", ctx.wrapper());
      }
    },
    inputs: {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ChartjsComponent, [{
    ...
    getDatasetAtEvent: [{
      type: Output,
      args: ["getDatasetAtEvent"]
    }],
    getElementAtEvent: [{
      type: Output,
      args: ["getElementAtEvent"]
    }],
    getElementsAtEvent: [{
      type: Output,
      args: ["getElementsAtEvent"]
    }],
    chartRef: [{
      type: Output,
      args: ["chartRef"]
...
function DashboardComponent_ng_template_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", ctx_r0.calPerc(ctx_r0.statistiche().generale.libere, ctx_r0.statistiche().generale.totali));
  }
}
...
function DashboardComponent_ng_template_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("value", ctx_r0.calPerc(ctx_r0.statistiche().generale.occupate, ctx_r0.statistiche().generale.totali));
  }
}
...
function DashboardComponent_ng_template_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("value", ctx_r0.calPerc(ctx_r0.statistiche().generale.indisponibili, ctx_r0.statistiche().generale.totali));
  }
}
...
function DashboardComponent_ng_template_23_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("value", ctx_r0.calPerc(ctx_r0.statistiche().generale.nd, ctx_r0.statistiche().generale.totali));
  }
}
var DashboardComponent = class _DashboardComponent {
  constructor() {
    this.statisticheService = inject(DashboardService);
    this.router = inject(Router);
    this.tessereStatusMsg = TESSERE_STATUS_MESSAGES;
    this.icons = { cilTrash, cilUser, cilUserFollow, cilUserUnfollow };
    this.statistiche = signal({
      generale: {
        totali: 0,
        libere: 0,
        occupate: 0,
    ...
    }, ...ngDevMode ? [{ debugName: "statistiche" }] : (
      /* istanbul ignore next */
      []
    ));
    this.options = {
    ...
    this.chartBarTessereData = signal({
      labels: [],
      datasets: [
        {
          label: "# Badge",
    ...
    }, ...ngDevMode ? [{ debugName: "chartBarTessereData" }] : (
      /* istanbul ignore next */
      []
    ));
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["ng-component"]], decls: 32, vars: 12, consts: [["lg", "1", "xs", "1"], ["lg", "2", "xs", "6"], ["color", "primary", "inverse", "", 1, "shadow-card", 3, "click", "title", "value"], ["cTemplateId", "widgetIconTemplate"], ["cTemplateId", "widgetProgressTemplate"], ["color", "success", "inverse", "", 1, "shadow-card", 3, "click", "title", "value"], ["color", "warning", "inverse", "", 1, "shadow-card", 3, "click", "title", "value"], ["color", "danger", "inverse", "", 1, "shadow-card", 3, "click", "title", "value"], ["color", "secondary", "inverse", "", 1, "shadow-card", 3, "click", "title", "value"], ["xs", "12", "lg", "12"], [1, "mb-4"], ["type", "bar", 3, "data", "options"], ["cIcon", "", "height", "25", "name", "cilUser"], ["thin", "", "white", "", 1, "mt-3", "mb-0", 3, "value"], ["cIcon", "", "height", "25", "name", "cilUserFollow"], ["cIcon", "", "height", "25", "name", "cilUserUnfollow"], ["cIcon", "", "height", "25", "name", "cilTrash"]], template: function DashboardComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "h3");
        \u0275\u0275text(1, "Statistiche Tessere");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(2, "c-row");
        \u0275\u0275element(3, "c-col", 0);
        \u0275\u0275elementStart(4, "c-col", 1)(5, "c-widget-stat-c", 2);
        \u0275\u0275listener("click", function DashboardComponent_Template_c_widget_stat_c_click_5_listener() {
          return ctx.goTo("/liste/tessere");
        });
        \u0275\u0275template(6, DashboardComponent_ng_template_6_Template, 1, 0, "ng-template", 3)(7, DashboardComponent_ng_template_7_Template, 1, 1, "ng-template", 4);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(8, "c-col", 1)(9, "c-widget-stat-c", 5);
        \u0275\u0275listener("click", function DashboardComponent_Template_c_widget_stat_c_click_9_listener() {
          return ctx.goTo("/liste/tessere", { stato: ctx.tessereStatusMsg.LIBERA });
        });
        \u0275\u0275template(10, DashboardComponent_ng_template_10_Template, 1, 0, "ng-template", 3)(11, DashboardComponent_ng_template_11_Template, 1, 1, "ng-template", 4);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(12, "c-col", 1)(13, "c-widget-stat-c", 6);
        \u0275\u0275listener("click", function DashboardComponent_Template_c_widget_stat_c_click_13_listener() {
          return ctx.goTo("/liste/tessere", { stato: ctx.tessereStatusMsg.OCCUPATA });
        });
        \u0275\u0275template(14, DashboardComponent_ng_template_14_Template, 1, 0, "ng-template", 3)(15, DashboardComponent_ng_template_15_Template, 1, 1, "ng-template", 4);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(16, "c-col", 1)(17, "c-widget-stat-c", 7);
        \u0275\u0275listener("click", function DashboardComponent_Template_c_widget_stat_c_click_17_listener() {
          return ctx.goTo("/liste/tessere", { stato: ctx.tessereStatusMsg.INDISPONIBILE });
        });
        \u0275\u0275template(18, DashboardComponent_ng_template_18_Template, 1, 0, "ng-template", 3)(19, DashboardComponent_ng_template_19_Template, 1, 1, "ng-template", 4);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(20, "c-col", 1)(21, "c-widget-stat-c", 8);
        \u0275\u0275listener("click", function DashboardComponent_Template_c_widget_stat_c_click_21_listener() {
          return ctx.goTo("/liste/tessere", { stato: ctx.tessereStatusMsg.ND });
        });
        \u0275\u0275template(22, DashboardComponent_ng_template_22_Template, 1, 0, "ng-template", 3)(23, DashboardComponent_ng_template_23_Template, 1, 1, "ng-template", 4);
        \u0275\u0275elementEnd()()();
        \u0275\u0275element(24, "hr");
        \u0275\u0275elementStart(25, "c-row")(26, "c-col", 9)(27, "c-card", 10)(28, "c-card-header");
        \u0275\u0275text(29, " Per Sedi ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(30, "c-card-body");
        \u0275\u0275element(31, "c-chart", 11);
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(5);
        \u0275\u0275property("title", "Totali")("value", ctx.statistiche().generale.totali);
        \u0275\u0275advance(4);
        \u0275\u0275property("title", ctx.tessereStatusMsg.LIBERA_DESC_PLU)("value", ctx.statistiche().generale.libere);
        \u0275\u0275advance(4);
        \u0275\u0275property("title", ctx.tessereStatusMsg.OCCUPATA_DESC_PLU)("value", ctx.statistiche().generale.occupate);
        \u0275\u0275advance(4);
        \u0275\u0275property("title", ctx.tessereStatusMsg.INDISPONIBILE_DESC_PLU)("value", ctx.statistiche().generale.indisponibili);
        \u0275\u0275advance(4);
        \u0275\u0275property("title", ctx.tessereStatusMsg.ND_DESC)("value", ctx.statistiche().generale.nd || 0);
        \u0275\u0275advance(10);
        \u0275\u0275property("data", ctx.chartBarTessereData())("options", ctx.options);
      }
    }, dependencies: [
      RowComponent,
      ColComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DashboardComponent, [{
    ...
    args: [{ imports: [
      ...
      CardBodyComponent,
      ChartjsComponent
    ], template: `<!-- <c-container> -->\r
<h3>Statistiche Tessere</h3>\r
<c-row>\r
   <c-col lg="1" xs="1">\r
\r
   </c-col>\r
  <c-col lg="2" xs="6">\r
    <c-widget-stat-c\r
      ...
      color="primary"\r
      inverse\r
      [value]="this.statistiche().generale.totali"\r
      (click)="goTo('/liste/tessere')"\r
      class="shadow-card"\r
    >\r
      <ng-template cTemplateId="widgetIconTemplate">\r
        <svg cIcon height="25" name="cilUser"></svg>\r
      </ng-template>\r
      <ng-template cTemplateId="widgetProgressTemplate">\r
        <c-progress class="mt-3 mb-0" thin white [value]="100" />\r
      </ng-template>\r
    </c-widget-stat-c>\r
  </c-col>\r
\r
  <c-col lg="2" xs="6">\r
    <c-widget-stat-c\r
      [title]="tessereStatusMsg.LIBERA_DESC_PLU"\r
      color="success"\r
      inverse\r
      (click)="goTo('/liste/tessere', { stato: tessereStatusMsg.LIBERA })"\r
      [value]="this.statistiche().generale.libere"\r
      class="shadow-card"\r
    >\r
      <ng-template cTemplateId="widgetIconTemplate">\r
        <svg cIcon height="25" name="cilUserFollow"></svg>\r
      </ng-template>\r
      <ng-template cTemplateId="widgetProgressTemplate">\r
        <c-progress\r
          class="mt-3 mb-0"\r
          ...
          [value]="\r
            calPerc(\r
              this.statistiche().generale.libere,\r
              this.statistiche().generale.totali\r
            )\r
          "\r
        />\r
      </ng-template>\r
...
\r
  <c-col lg="2" xs="6">\r
    <c-widget-stat-c\r
      [title]="tessereStatusMsg.OCCUPATA_DESC_PLU"\r
      color="warning"\r
      inverse\r
      [value]="this.statistiche().generale.occupate"\r
      (click)="goTo('/liste/tessere', { stato: tessereStatusMsg.OCCUPATA })"\r
      class="shadow-card"\r
    >\r
      <ng-template cTemplateId="widgetIconTemplate">\r
        <svg cIcon height="25" name="cilUserUnfollow"></svg>\r
      </ng-template>\r
      <ng-template cTemplateId="widgetProgressTemplate">\r
        <c-progress\r
          class="mt-3 mb-0"\r
          ...
          [value]="\r
            calPerc(\r
              this.statistiche().generale.occupate,\r
              this.statistiche().generale.totali\r
            )\r
          "\r
        />\r
...
\r
  <c-col lg="2" xs="6">\r
    <c-widget-stat-c\r
      [title]="tessereStatusMsg.INDISPONIBILE_DESC_PLU"\r
      color="danger"\r
      inverse\r
      (click)="goTo('/liste/tessere', { stato: tessereStatusMsg.INDISPONIBILE })"\r
      [value]="this.statistiche().generale.indisponibili"\r
      class="shadow-card"\r
    >\r
      <ng-template cTemplateId="widgetIconTemplate">\r
        <svg cIcon height="25" name="cilTrash"></svg>\r
      </ng-template>\r
      <ng-template cTemplateId="widgetProgressTemplate">\r
        <c-progress\r
          class="mt-3 mb-0"\r
          ...
          [value]="\r
            calPerc(\r
              this.statistiche().generale.indisponibili,\r
              this.statistiche().generale.totali\r
            )\r
          "\r
        />\r
...
\r
  <c-col lg="2" xs="6">\r
    <c-widget-stat-c\r
      [title]="tessereStatusMsg.ND_DESC"\r
      color="secondary"\r
      inverse\r
      (click)="goTo('/liste/tessere', { stato: tessereStatusMsg.ND })"\r
      [value]="this.statistiche().generale.nd || 0"\r
      class="shadow-card"\r
    >\r
      <ng-template cTemplateId="widgetIconTemplate">\r
        <svg cIcon height="25" name="cilTrash"></svg>\r
      ...
      <ng-template cTemplateId="widgetProgressTemplate">\r
        <c-progress\r
          ...
          [value]="\r
            calPerc(\r
              this.statistiche().generale.nd,\r
              this.statistiche().generale.totali\r
            )\r
          "\r
        />\r
...
<c-row>\r
  <c-col xs="12" lg="12">\r
    <c-card class="mb-4">\r
      <c-card-header> Per Sedi </c-card-header>\r
      <c-card-body>\r
        <c-chart\r
          type="bar"\r
          [data]="chartBarTessereData()"\r
          [options]="options"\r
        />\r
      </c-card-body>\r
    </c-card>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardComponent, { className: "DashboardComponent", filePath: "src/app/views/dashboard/dashboard.component.ts", lineNumber: 28 });
})();
export {
  DashboardComponent
};
//# sourceMappingURL=chunk-VV426GVN.js.map
