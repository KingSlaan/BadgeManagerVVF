...
var version_default = {
  version: "1.2.4-Root",
  environment: "dev",
  buildDate: "2026-06-12T09:33:01.160Z"
};
...
function DefaultHeaderComponent_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "c-dropdown", 9)(1, "button", 10);
    \u0275\u0275element(2, "c-avatar", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ul", 12)(4, "li")(5, "h6", 13);
    \u0275\u0275text(6, " Settings ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "li", 14)(8, "a", 15);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(9, "svg", 16);
    \u0275\u0275text(10, " Change Avatar ");
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(11, "li")(12, "a", 17);
    \u0275\u0275listener("click", function DefaultHeaderComponent_ng_template_11_Template_a_click_12_listener() {
      \u0275\u0275restoreView(_r1);
...
function DefaultHeaderComponent_ng_template_13_For_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 24);
    \u0275\u0275listener("click", function DefaultHeaderComponent_ng_template_13_For_5_Template_button_click_0_listener() {
...
function DefaultHeaderComponent_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "c-dropdown", 19)(1, "button", 20);
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(2, "svg", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(3, "div", 22);
    \u0275\u0275repeaterCreate(4, DefaultHeaderComponent_ng_template_13_For_5_Template, 3, 3, "button", 23, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DefaultHeaderComponent, selectors: [["app-default-header"]], inputs: { sidebarId: [1, "sidebarId"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 15, vars: 7, consts: [["userDropdown", ""], ["themeDropdown", ""], [1, "border-bottom", "px-4", 3, "fluid"], ["cHeaderToggler", "", "toggle", "visible", "aria-label", "Toggle sidebar navigation", 1, "btn", 2, "margin-inline-start", "-14px", 3, "cSidebarToggle"], ["cIcon", "", "name", "cilMenu", "size", "lg"], [1, "mx-0", "d-flex", "align-items-center", "gap-2"], [3, "ngClass"], [4, "ngTemplateOutlet"], [1, "px-4", 3, "fluid"], ["variant", "nav-item", 3, "popperOptions"], ["cDropdownToggle", "", "aria-label", "Open user menu", 1, "py-0", "pe-0", 3, "caret"], ["shape", "rounded-1", "size", "md", "src", "./assets/images/placeholder_icon_user.svg", "status", "success", "textColor", "primary", "alt", "User avatar"], ["cDropdownMenu", "", 1, "pt-0", "w-auto"], ["cDropdownHeader", "", 1, "bg-body-secondary", "text-body-secondary", "fw-semibold", "p-2"], [1, "pX-0"], ["cDropdownItem", "", "routerLink", "user-settings"], ["cIcon", "", "name", "cilSettings", 1, "me-2"], ["cDropdownItem", "", 3, "click"], ["cIcon", "", "name", "cilAccountLogout", 1, "me-2"], ["alignment", "end", "variant", "nav-item"], ["cDropdownToggle", "", "aria-label", "Open theme picker", 3, "caret"], ["cIcon", "", "size", "lg", 3, "name"], ["cDropdownMenu", ""], ["cDropdownItem", "", 1, "d-flex", "align-items-center", 3, "active"], ["cDropdownItem", "", 1, "d-flex", "align-items-center", 3, "click", "active"], ["cIcon", "", "size", "lg", 1, "me-2", 3, "name"]], template: function DefaultHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(6);
        \u0275\u0275elementEnd();
        \u0275\u0275template(7, DefaultHeaderComponent_ng_container_7_Template, 1, 0, "ng-container", 7)(8, DefaultHeaderComponent_ng_container_8_Template, 1, 0, "ng-container", 7);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(9, "c-container", 8);
        \u0275\u0275element(10, "c-breadcrumb-router");
        \u0275\u0275elementEnd();
        \u0275\u0275elementContainerEnd();
        \u0275\u0275template(11, DefaultHeaderComponent_ng_template_11_Template, 15, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(13, DefaultHeaderComponent_ng_template_13_Template, 6, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        const userDropdown_r5 = \u0275\u0275reference(12);
        const themeDropdown_r6 = \u0275\u0275reference(14);
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DefaultHeaderComponent, { className: "DefaultHeaderComponent", filePath: "src/app/layout/default-layout/default-header/default-header.component.ts", lineNumber: 43 });
})();
...
//# sourceMappingURL=chunk-6QYJ3BJB.js.map
