...
function DataGridComponent_Conditional_6_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, DataGridComponent_Conditional_6_Conditional_3_Conditional_1_Template, 1, 1, "input", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_2_0;
...
function DataGridComponent_Conditional_6_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275conditionalCreate(3, DataGridComponent_Conditional_6_For_5_Conditional_3_Template, 2, 1, "span", 39);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DataGridComponent_Conditional_6_For_9_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "td")(1, "input", 36);
...
function DataGridComponent_Conditional_6_For_9_For_3_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, DataGridComponent_Conditional_6_For_9_For_3_Conditional_1_ng_container_0_Template, 1, 0, "ng-container", 45);
  }
  if (rf & 2) {
...
function DataGridComponent_Conditional_6_For_9_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275conditionalCreate(1, DataGridComponent_Conditional_6_For_9_For_3_Conditional_1_Template, 1, 6, "ng-container")(2, DataGridComponent_Conditional_6_For_9_For_3_Conditional_2_Template, 1, 1, "span", 44);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DataGridComponent_Conditional_6_For_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, DataGridComponent_Conditional_6_For_9_For_3_Template, 3, 3, "td", 43, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_13_0;
...
function DataGridComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(3, DataGridComponent_Conditional_6_Conditional_3_Template, 2, 1, "th", 31);
    \u0275\u0275repeaterCreate(4, DataGridComponent_Conditional_6_For_5_Template, 4, 6, "th", 32, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "tbody");
    \u0275\u0275conditionalCreate(7, DataGridComponent_Conditional_6_Conditional_7_Template, 4, 1, "div", 33);
    \u0275\u0275repeaterCreate(8, DataGridComponent_Conditional_6_For_9_Template, 4, 5, "tr", 34, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_1_0;
...
function DataGridComponent_Conditional_8_Conditional_1_For_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", size_r22);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", size_r22, " ");
  }
}
...
function DataGridComponent_Conditional_8_For_17_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DataGridComponent_Conditional_8_For_17_Conditional_1_Template_button_click_0_listener() {
      ...
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.changePage(p_r24));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const p_r24 = \u0275\u0275nextContext().$implicit;
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("color", p_r24 === ctx_r3.paginationConfig().page ? "primary" : "secondary");
    \u0275\u0275advance();
...
function DataGridComponent_Conditional_8_For_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, DataGridComponent_Conditional_8_For_17_Conditional_0_Template, 2, 0, "span", 50)(1, DataGridComponent_Conditional_8_For_17_Conditional_1_Template, 2, 2, "button", 51);
  }
  if (rf & 2) {
    const p_r24 = ctx.$implicit;
    \u0275\u0275conditional(p_r24 === "ellipsis" ? 0 : 1);
  }
}
function DataGridComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, DataGridComponent_Conditional_8_Conditional_1_Template, 6, 2, "div", 38);
    ...
    \u0275\u0275text(12, " items ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 47)(14, "button", 48);
...
function DataGridComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, DataGridComponent_Conditional_9_ng_container_1_Template, 1, 0, "ng-container", 45);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
var DataGridComponent = class _DataGridComponent {
  ...
  static {
    ...
    }, inputs: { loading: [1, "loading"], rows: [1, "rows"], columns: [1, "columns"], paginationConfig: [1, "paginationConfig"], searchConfig: [1, "searchConfig"], sortingConfig: [1, "sortingConfig"], loadingConfig: [1, "loadingConfig"], emptyStateConfig: [1, "emptyStateConfig"], toolbarConfig: [1, "toolbarConfig"], persistConfig: [1, "persistConfig"], contextMenuConfig: [1, "contextMenuConfig"], selectionConfig: [1, "selectionConfig"] }, outputs: { selectionChange: "selectionChange", dataRequest: "dataRequest" }, decls: 10, vars: 5, consts: [[1, "my-4"], ["cForm", "", "cRow", "", 3, "gutter"], [1, "datagrid-empty-state"], ["cTable", ""], [1, "d-flex", "align-items-center", "justify-content-between", "gap-3", "flex-wrap"], [1, "datagrid-context-menu", 3, "left", "top"], [3, "xs"], ["xs", "2"], [1, "d-flex", "gap-2", "flex-wrap"], ["cButton", "", "color", "primary", "variant", "ghost", "shape", "rounded-pill", 3, "click"], ["title", "Ricerca", 3, "cIcon"], ["cButton", "", "color", "danger", "variant", "ghost", "shape", "rounded-pill", 3, "click"], ["title", "Pulisci Filtri", 3, "cIcon"], ["cFormControl", "", "type", "text", 3, "name", "ngModel", "placeholder"], ["cSelect", "", 3, "name", "ngModel"], ["min", "1900-01-01", "max", "2100-12-31", 3, "name", "ngModel", "placeholder"], [1, "form-check", "mt-2"], [3, "name", "ngModel", "placeholder", "options", "multiple"], ["cFormControl", "", "type", "text", 3, "ngModelChange", "keydown", "name", "ngModel", "placeholder"], ["cSelect", "", 3, "ngModelChange", "name", "ngModel"], ["value", ""], [3, "value"], ["min", "1900-01-01", "max", "2100-12-31", 3, "ngModelChange", "keydown", "name", "ngModel", "placeholder"], ["cFormCheckInput", "", "type", "checkbox", 3, "ngModelChange", "name", "ngModel"], [1, "form-check-label"], [3, "ngModelChange", "name", "ngModel", "placeholder", "options", "multiple"], [1, "d-flex", "gap-2", "mb-3", "flex-wrap", "justify-content-end"], ["cButton", "", "variant", "ghost", "shape", "rounded-pill", "size", "sm", 3, "color", "disabled"], ["cButton", "", "variant", "ghost", "shape", "rounded-pill", "size", "sm", 3, "click", "color", "disabled"], ["title", "Pulisci Filtri", "size", "3xl", 1, "mb-3", "text-medium-emphasis", 3, "cIcon"], [1, "text-medium-emphasis"], [2, "width", "48px"], [3, "width", "sortable"], [1, "datagrid-loading-overlay"], [3, "datagrid-row-even", "datagrid-row-odd"], ["cFormCheckInput", "", "type", "checkbox", 3, "checked"], ["cFormCheckInput", "", "type", "checkbox", 3, "click", "checked"], [3, "click"], [1, "d-flex", "align-items-center", "gap-2"], [1, "sort-icon"], ["size", "sm"], [1, "ms-2"], [3, "contextmenu", "click"], [3, "class"], [3, "innerHTML"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "d-flex", "gap-1", "align-items-center", "text-body-secondary", "small"], [1, "d-flex", "gap-1", "align-items-center"], ["cButton", "", "color", "secondary", "size", "sm", "variant", "ghost", 3, "click", "disabled"], ["cSelect", "", 2, "width", "120px", 3, "change", "value"], [1, "px-2", "text-body-secondary"], ["cButton", "", "size", "sm", "variant", "ghost", 3, "color"], ["cButton", "", "size", "sm", "variant", "ghost", 3, "click", "color"], [1, "datagrid-context-menu", 3, "click"]], template: function DataGridComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=chunk-SSA7BT6P.js.map
