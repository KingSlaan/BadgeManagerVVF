...
var ListeHomeComponent = class _ListeHomeComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ListeHomeComponent, selectors: [["app-liste-home"]], decls: 3, vars: 0, consts: [[1, "cards-grid"], [1, "menu-card", 3, "routerLink"], [3, "cIcon"]], template: function ListeHomeComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ListeHomeComponent, [{
    ...
    args: [{ selector: "app-liste-home", imports: [
      RouterLink,
      IconDirective
    ], template: '<div class="cards-grid">\r\n  @for (card of cards(); track card.route) {\r\n    <div class="menu-card" [routerLink]="card.route">\r\n      <svg [cIcon]="card.icon"></svg>\r\n\r\n      <h4>{{ card.title }}</h4>\r\n\r\n      <p>{{ card.description }}</p>\r\n    </div>\r\n  }\r\n</div>\r\n', styles: ["/* src/app/views/pages/liste-home/liste-home.component.scss */\n.cards-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(280px, 1fr));\n  gap: 2rem;\n}\n.menu-card {\n  cursor: pointer;\n  padding: 2rem;\n  border-radius: 0.75rem;\n  background: var(--cui-body-bg);\n  border: 1px solid var(--cui-border-color);\n  transition: 0.2s;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n}\n.menu-card:hover {\n  transform: translateY(-4px);\n  box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15);\n  border-color: var(--cui-primary);\n}\n/*# sourceMappingURL=liste-home.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ListeHomeComponent, { className: "ListeHomeComponent", filePath: "src/app/views/pages/liste-home/liste-home.component.ts", lineNumber: 15 });
})();
export {
  ListeHomeComponent
};
//# sourceMappingURL=chunk-3L3EOHT3.js.map
