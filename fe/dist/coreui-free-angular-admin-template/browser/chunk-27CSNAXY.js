  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DatepickerComponent, selectors: [["app-datepicker"]], inputs: { label: "label", min: "min", max: "max", disabled: "disabled", invalid: "invalid", helperText: "helperText", placeholder: "placeholder", showTodayButton: "showTodayButton", showSpecificDateButton: "showSpecificDateButton", specificDateValue: "specificDateValue", todayButtonLabel: "todayButtonLabel", specificDateButtonLabel: "specificDateButtonLabel", showTime: "showTime", readonly: "readonly" }, features: [\u0275\u0275ProvidersFeature([
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("type", ctx.showTime ? "datetime-local" : "date")("value", ctx.value || "")("min", ctx.min)("max", ctx.max)("disabled", ctx.disabled)("readonly", ctx.readonly);
        \u0275\u0275advance(2);
        \u0275\u0275classProp("is-readonly", ctx.readonly);
        \u0275\u0275property("value", ctx.displayValue)("placeholder", ctx.placeholder)("disabled", ctx.disabled);
        \u0275\u0275advance(2);
...
var AutocompleteSelectComponent = class _AutocompleteSelectComponent {
  constructor(elementRef) {
    ...
    this.selectedOptions = signal([], ...ngDevMode ? [{ debugName: "selectedOptions" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  writeValue(value) {
    if (this.multiple()) {
      ...
      const selectedOptions = this.getAllOptions().filter((option) => values.includes(option.value));
  ...
  selectOption(option) {
    if (this.multiple()) {
      const exists = this.selectedOptions().some((opt) => opt.value === option.value);
      if (exists) {
        this.search.set("");
  ...
  removeSelected(value) {
    const nextOptions = this.selectedOptions().filter((opt) => opt.value !== value);
    this.selectedOptions.set(nextOptions);
  ...
  getSelectedOptions() {
    return this.multiple() ? this.selectedOptions() : this.getAllOptions().filter((opt) => opt.value === this.selectedValue());
  }
  clear() {
    if (this.multiple()) {
...
//# sourceMappingURL=chunk-27CSNAXY.js.map
