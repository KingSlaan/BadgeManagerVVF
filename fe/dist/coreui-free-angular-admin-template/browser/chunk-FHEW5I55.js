...
function AutocompleteSelectComponent_Conditional_2_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AutocompleteSelectComponent_Conditional_2_For_2_Template_button_click_2_listener($event) {
...
function AutocompleteSelectComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, AutocompleteSelectComponent_Conditional_2_For_2_Template, 4, 1, "span", 6, _forTrack0);
...
function AutocompleteSelectComponent_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 13);
    \u0275\u0275listener("click", function AutocompleteSelectComponent_Conditional_5_For_2_Template_button_click_0_listener() {
...
function AutocompleteSelectComponent_Conditional_5_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function AutocompleteSelectComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, AutocompleteSelectComponent_Conditional_5_For_2_Template, 2, 3, "button", 11, _forTrack1);
    \u0275\u0275conditionalCreate(3, AutocompleteSelectComponent_Conditional_5_Conditional_3_Template, 2, 0, "div", 12);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r3.filteredOptions().length === 0 ? 3 : -1);
  }
}
var AutocompleteSelectComponent = class _AutocompleteSelectComponent {
  ...
  static {
    ...
    }, inputs: { options: [1, "options"], placeholder: [1, "placeholder"], disabledInput: [1, "disabledInput"], clearable: [1, "clearable"], multiple: [1, "multiple"] }, features: [\u0275\u0275ProvidersFeature([
      {
        provide: NG_VALUE_ACCESSOR,
        useExisting: forwardRef(() => _AutocompleteSelectComponent),
        multi: true
      }
    ])], decls: 6, vars: 3, consts: [[1, "autocomplete-select"], [1, "autocomplete-input-wrapper", 3, "click"], [1, "selected-tags"], ["type", "text", 1, "form-control", "autocomplete-input", 3, "placeholder", "ngModel", "disabled"], ["type", "button", "title", "Clear", 1, "clear-btn"], [1, "autocomplete-dropdown"], [1, "selected-tag"], ["type", "text", 1, "tag-input", 3, "ngModelChange", "focus", "placeholder", "ngModel", "disabled"], ["type", "button", 1, "tag-remove", 3, "click"], ["type", "text", 1, "form-control", "autocomplete-input", 3, "ngModelChange", "focus", "placeholder", "ngModel", "disabled"], ["type", "button", "title", "Clear", 1, "clear-btn", 3, "click"], ["type", "button", 1, "autocomplete-option", 3, "selected"], [1, "autocomplete-empty"], ["type", "button", 1, "autocomplete-option", 3, "click"]], template: function AutocompleteSelectComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(5, AutocompleteSelectComponent_Conditional_5_Template, 4, 1, "div", 5);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AutocompleteSelectComponent, [{
    type: Component,
    args: [{ selector: "app-autocomplete-select", standalone: true, imports: [CommonModule, FormsModule], providers: [
      {
        provide: NG_VALUE_ACCESSOR,
...
\r
      @if (filteredOptions().length === 0) {\r
        <div class="autocomplete-empty">No results found</div>\r
      }\r
    </div>\r
  }\r
</div>\r
`, styles: ["/* src/components/autocomplete-select/autocomplete-select.component.scss */\n.autocomplete-select {\n  position: relative;\n  width: 100%;\n}\n.autocomplete-input-wrapper {\n  position: relative;\n}\n.autocomplete-input {\n  padding-right: 2.25rem;\n}\n.clear-btn {\n  position: absolute;\n  top: 50%;\n  right: 0.75rem;\n  transform: translateY(-50%);\n  border: 0;\n  background: transparent;\n  font-size: 1.25rem;\n  line-height: 1;\n  color: var(--cui-secondary-color);\n  cursor: pointer;\n}\n.clear-btn:hover {\n  color: var(--cui-body-color);\n}\n.autocomplete-dropdown {\n  position: absolute;\n  z-index: 1050;\n  width: 100%;\n  margin-top: 0.25rem;\n  max-height: 240px;\n  overflow-y: auto;\n  border: 1px solid var(--cui-border-color);\n  border-radius: var(--cui-border-radius);\n  background-color: var(--cui-body-bg);\n  color: var(--cui-body-color);\n  box-shadow: var(--cui-box-shadow);\n}\n.autocomplete-option {\n  width: 100%;\n  padding: 0.5rem 0.75rem;\n  border: 0;\n  text-align: left;\n  background: transparent;\n  color: var(--cui-body-color);\n  cursor: pointer;\n}\n.autocomplete-option:hover {\n  background-color: var(--cui-tertiary-bg);\n}\n.autocomplete-option.selected {\n  background-color: var(--cui-primary);\n  color: #fff;\n}\n.autocomplete-empty {\n  padding: 0.75rem;\n  color: var(--cui-secondary-color);\n}\n:host-context([data-coreui-theme=dark]) .autocomplete-dropdown {\n  background-color: var(--cui-dark-bg-subtle);\n  border-color: var(--cui-border-color);\n}\n:host-context([data-coreui-theme=dark]) .autocomplete-option:hover {\n  background-color: rgba(255, 255, 255, 0.08);\n}\n.selected-tags {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.35rem;\n  min-height: 38px;\n  padding: 0.25rem 2.25rem 0.25rem 0.5rem;\n  border: 1px solid var(--cui-border-color);\n  border-radius: var(--cui-border-radius);\n  background-color: var(--cui-body-bg);\n  color: var(--cui-body-color);\n}\n.selected-tag {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n  padding: 0.15rem 0.45rem;\n  border-radius: 999px;\n  background-color: var(--cui-tertiary-bg);\n  color: var(--cui-body-color);\n}\n.tag-remove {\n  border: 0;\n  background: transparent;\n  color: inherit;\n  cursor: pointer;\n}\n.tag-input {\n  flex: 1;\n  min-width: 120px;\n  border: 0;\n  outline: none;\n  background: transparent;\n  color: var(--cui-body-color);\n}\n/*# sourceMappingURL=autocomplete-select.component.css.map */\n"] }]
  }], () => [{ type: ElementRef }], { options: [{ type: Input, args: [{ isSignal: true, alias: "options", required: false }] }], placeholder: [{ type: Input, args: [{ isSignal: true, alias: "placeholder", required: false }] }], disabledInput: [{ type: Input, args: [{ isSignal: true, alias: "disabledInput", required: false }] }], clearable: [{ type: Input, args: [{ isSignal: true, alias: "clearable", required: false }] }], multiple: [{ type: Input, args: [{ isSignal: true, alias: "multiple", required: false }] }], clickOutside: [{
    type: HostListener,
    args: ["document:click", ["$event"]]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AutocompleteSelectComponent, { className: "AutocompleteSelectComponent", filePath: "src/components/autocomplete-select/autocomplete-select.component.ts", lineNumber: 36 });
})();
...
//# sourceMappingURL=chunk-FHEW5I55.js.map
